...
#define HETGPU_SIFIVE_HAVE_SIFIVE_VECTOR 1
#endif
#endif

#if defined(__riscv) && defined(__riscv_vector) && \
    defined(__riscv_xsfvfwmaccqqq) && defined(__riscv_zvfbfmin) && \
    defined(HETGPU_SIFIVE_HAVE_SIFIVE_VECTOR)
#define HETGPU_SIFIVE_HAVE_XSFMM_BF16 1
#endif

#define HETGPU_SIFIVE_JOB_MAGIC 0x4847505550414343ULL
#define HETGPU_SIFIVE_BEACON_MAGIC 0x4847505542434e31ULL
#define HETGPU_SIFIVE_JOB_VERSION 1U
#define SIFIVE_JOB_MAGIC 0x504143434a4f4231ULL
#define SIFIVE_JOB_VERSION 1U
#define SIFIVE_JOB_FLAG_HAS_LAUNCH_ABI (1U << 0)
#define SIFIVE_KERNEL_LAUNCH_ABI_MAGIC 0x5041434341524731ULL
#define SIFIVE_KERNEL_LAUNCH_ABI_VERSION 1U
#define SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES 72U
#define SIFIVE_KERNEL_LAUNCH_ABI_WIRE_BYTES 48U
#define SIFIVE_KERNEL_ARG_RECORD_WIRE_BYTES 32U
#define SIFIVE_KERNEL_BUFFER_BINDING_WIRE_BYTES 24U
#define SIFIVE_KERNEL_ARG_FLAG_INLINE_BLOB (1U << 16)
#define SIFIVE_KERNEL_ARG_FLAG_BUFFER_INPUT (1U << 8)
#define SIFIVE_KERNEL_ARG_FLAG_BUFFER_OUTPUT (1U << 9)
#define SIFIVE_KERNEL_JOB_ID 0U
...
#define HETGPU_SIFIVE_MAX_JOB_ID 16U
...
#define HETGPU_SIFIVE_RUNTIME_TABLE_MAGIC 0x4847505554424c31ULL
#define HETGPU_SIFIVE_RUNTIME_TABLE_VERSION 1U
#define HETGPU_SIFIVE_COUNT 4U
#define HETGPU_SIFIVE_ID_CLAIM_OFF 0x1ee0UL
#define HETGPU_SIFIVE_ID_CLAIM_MAGIC 0x4847505550494400ULL
#define AP2SIFIVE_MBOX_PHYS 0x20000000ULL
#define SIFIVE2AP_MBOX_PHYS 0x20002000ULL
#define HETGPU_SIFIVE_DEFAULT_SHARED_DDR_BYTES 0x100000000ULL
#define HETGPU_SIFIVE_SHARED_DDR_USER_OFF 0x00100000ULL
#define HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF HETGPU_SIFIVE_SHARED_DDR_USER_OFF
#define HETGPU_SIFIVE_COMPLETION_OFF 0x1f20ULL
#define HETGPU_SIFIVE_COMPLETION_MIRROR_DEFAULT_OFF 0x120e0ULL
#define HETGPU_SIFIVE_BEACON_OFF 0x1f40ULL
#define HETGPU_SIFIVE_DIAG_RING_SLOT 8U
#define HETGPU_SIFIVE_DIAG_RING_OFF 0x0000ULL
#define HETGPU_SIFIVE_DIAG_RING_RECORDS 192U
#define HETGPU_SIFIVE_DIAG_MAGIC 0x4847505544494147ULL
#define HETGPU_SIFIVE_RMS_DEBUG_SLOT 9U
#define HETGPU_SIFIVE_RMS_DEBUG_RECORD_BYTES 0x100ULL
#define HETGPU_SIFIVE_RMS_DEBUG_MAGIC 0x48475055524d5344ULL
...
#define SIFIVE_GEMM_THREADS 32U
#define SIFIVE_XSFMM16_TILE_M 32U
#define SIFIVE_XSFMM16_TILE_N 32U
#define SIFIVE_XSFMM16_TILE_K 4U
#define SIFIVE_RVV_F32_TILE_M 32U
#define SIFIVE_RVV_F32_TILE_N 32U
#define SIFIVE_RVV_F32_TILE_K 32U
#define SIFIVE_GEMM_TILE_M_MAX SIFIVE_XSFMM16_TILE_M
#define SIFIVE_GEMM_TILE_N_MAX SIFIVE_XSFMM16_TILE_N
#define SIFIVE_KERNEL_DEFAULT_THREADS 32U
#define SIFIVE_KERNEL_MAX_THREADS 64U
#define SIFIVE_MAX_KERNEL_ARGS 64U
#define SIFIVE_MAX_KERNEL_BINDINGS 256U
...
#define SIFIVE_IOC_ZLUDA_IRQ_WITH_DDR _IOW(SIFIVE_IOC_MAGIC, 5, struct sifive_zluda_ddr_info)
...
#define SIFIVE_ELF_ET_REL 1U
#define SIFIVE_ELF_ET_EXEC 2U
#define SIFIVE_ELF_ET_DYN 3U
#define SIFIVE_ELF_PT_LOAD 1U
#define SIFIVE_ELF_SHT_SYMTAB 2U
#define SIFIVE_ELF_SHT_STRTAB 3U
#define SIFIVE_ELF_SHT_RELA 4U
#define SIFIVE_ELF_SHT_DYNSYM 11U
#define SIFIVE_ELF_STT_NOTYPE 0U
#define SIFIVE_ELF_STT_FUNC 2U
#define SIFIVE_R_RISCV_NONE 0U
#define SIFIVE_R_RISCV_64 2U
#define SIFIVE_R_RISCV_RELATIVE 3U
#define SIFIVE_R_RISCV_JUMP_SLOT 5U

#define SIFIVE_FNV64_OFFSET 0xcbf29ce484222325ULL
#define SIFIVE_FNV64_PRIME 0x100000001b3ULL

#if defined(__riscv_vector)
#define SIFIVE_RVV_UNUSED __attribute__((unused))
#else
#define SIFIVE_RVV_UNUSED
#endif
#if defined(__GNUC__) || defined(__clang__)
#define SIFIVE_UNUSED __attribute__((unused))
#else
#define SIFIVE_UNUSED
#endif
...
struct SifiveKernelLaunchAbiHeader {
    uint64_t magic;
    uint32_t version;
    uint32_t flags;
...
struct SifiveKernelBufferBinding {
    uint32_t arg_index;
    uint32_t flags;
    uint64_t addr;
    uint64_t size;
...
struct SifiveJobImage {
    struct SifiveJobImageHeader header;
    const uint8_t *elf;
    size_t elf_len;
    struct SifiveKernelLaunchAbiHeader abi_storage;
    const struct SifiveKernelLaunchAbiHeader *abi;
    struct SifiveKernelArgRecord arg_records_storage[SIFIVE_MAX_KERNEL_ARGS];
    const struct SifiveKernelArgRecord *arg_records;
    size_t arg_count;
    struct SifiveKernelBufferBinding bindings_storage[SIFIVE_MAX_KERNEL_BINDINGS];
    const struct SifiveKernelBufferBinding *bindings;
...
typedef void (*SifiveSetLaunchFn)(uint32_t, uint32_t, uint32_t,
...
static struct sifive_zluda_ddr_info g_ddr_info;
static uint64_t g_shared_ddr_sifive_base;
static uint64_t g_sifive_id;
...
static uint32_t g_pending_arg_header_sifive_id;
...
static uint8_t g_control_snapshot[HETGPU_SIFIVE_CONTROL_BYTES];
static uint8_t g_arg_slot_synthetic_control[HETGPU_SIFIVE_CONTROL_BYTES];
static uint64_t g_last_preloaded_seq_by_job[HETGPU_SIFIVE_MAX_JOB_ID];
...
static uint64_t shared_ddr_sifive_phys(uint64_t phys, size_t len);
...
static bool jobd_trace_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_TRACE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_kmsg_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_KMSG");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_log_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_LOG");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_mbox_poll_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_MBOX_POLL");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_initial_mbox_poll_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_INITIAL_MBOX_POLL");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_ddr_ioctl_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_DDR_IOCTL");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_force_elf_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_FORCE_ELF")) ||
           env_flag_true(getenv("HETGPU_SIFIVE_JOBD_DISABLE_NATIVE"));
}

static bool jobd_disable_native_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_DISABLE_NATIVE"));
}
...
static bool jobd_force_elf_for_symbol(const char *symbol) {
    ...
    if (!env_flag_true(getenv("HETGPU_SIFIVE_JOBD_FORCE_ELF"))) {
        return false;
    }
...
static bool jobd_elf_fallback_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_ELF_FALLBACK");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_generic_noop_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_GENERIC_NOOP");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_preloaded_noop_enabled(uint32_t job_id) {
    const char *all = getenv("HETGPU_SIFIVE_JOBD_PRELOADED_NOOP");
    const char *gemm = getenv("HETGPU_SIFIVE_JOBD_GEMM_NOOP");

    if (all && *all && env_flag_true(all)) {
        return true;
    }
    return job_id == HETGPU_SIFIVE_JOB_GEMM && gemm && *gemm && env_flag_true(gemm);
}

static bool jobd_gemm_tiled_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_GEMM_TILED");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_gemm_copy_io_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_GEMM_COPY_IO");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_shared_ddr_payload_pread_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_SHARED_DDR_PAYLOAD_PREAD");
    if (value && *value) {
        return env_flag_true(value);
    }
    /*
     * AP-published shared-DDR payloads can be stale through the SIFIVE-side
...
static bool jobd_shared_ddr_payload_pwrite_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_SHARED_DDR_PAYLOAD_PWRITE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_shared_ddr_payload_sync_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_SHARED_DDR_PAYLOAD_SYNC");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_clear_stale_control_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CLEAR_STALE_CONTROL");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_full_ddr_map_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_FULL_DDR_MAP");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static uint64_t jobd_full_ddr_map_bytes(void) {
    uint64_t requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_FULL_DDR_MAP_BYTES", 0);
    if (requested != 0) {
        return requested;
    }
    ...
    return HETGPU_SIFIVE_DEFAULT_SHARED_DDR_BYTES;
}

static uint64_t jobd_kernel_slot_map_bytes(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_SLOT_MAP_BYTES",
                                 0x04000000ULL);
}

static uint64_t jobd_kernel_slot_map_off(uint64_t map_bytes) {
    uint64_t requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_SLOT_MAP_OFF",
                                               UINT64_MAX);
...
static bool jobd_kernel_slot_map_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_KERNEL_SLOT_MAP");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_force_pread_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_FORCE_PREAD");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_status_pwrite_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_STATUS_PWRITE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_status_control_window_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_STATUS_CONTROL_WINDOW");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_status_mmap_fallback_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_STATUS_MMAP_FALLBACK");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_mbox_status_mmap_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_MBOX_STATUS_MMAP");
    return value && *value && env_flag_true(value);
}

static bool jobd_control_window_read_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CONTROL_WINDOW_READ");
    if (value && *value) {
        return env_flag_true(value);
    }
    /*
     * The host owns the shared-DDR control page updates.  Reusing the
     * long-lived SIFIVE-side mapping can lag behind the IRQ that announced the
...
static bool jobd_control_pread_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CONTROL_PREAD");
    if (value && *value) {
        return env_flag_true(value);
    }
    /*
     * The host publishes arg-slots in shared DDR.  On the current LX500 path,
     * the SIFIVE-side /dev/mem alias can keep a stale cacheline even while AP
     * /dev/sifive mmap shows the new header.  Use the fd-backed read as the
...
static bool jobd_kernel_metadata_first_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_KERNEL_METADATA_FIRST");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_arg_slot_scan_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_ARG_SLOT_SCAN");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_arg_slot_scan_all_sifive_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_ARG_SLOT_SCAN_ALL");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_full_control_snapshot_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_FULL_CONTROL_SNAPSHOT"));
}

static bool jobd_redispatch_seen_arg_slot_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_REDISPATCH_SEEN_ARG_SLOT");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_runtime_table_refresh_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_REFRESH_RUNTIME_TABLE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_progress_status_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_PROGRESS_STATUS"));
}

static bool jobd_progress_completion_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_PROGRESS_COMPLETION"));
}

static bool jobd_loop_trace_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_LOOP_TRACE"));
}

static bool jobd_sticky_kernel_completion_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_STICKY_KERNEL_COMPLETION"));
}

static bool jobd_sticky_preloaded_completion_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_STICKY_PRELOADED_COMPLETION"));
}

static bool jobd_require_completion_visible_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_REQUIRE_COMPLETION_VISIBLE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_diag_ring_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_DIAG_RING"));
}

static bool jobd_rms_debug_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_RMS_DEBUG");
    if (value && *value) {
        return env_flag_true(value);
    }
...
static bool jobd_rms_output_pwrite_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_RMS_OUTPUT_PWRITE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_beacon_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_BEACON");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_static_config_fallback_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_STATIC_CONFIG_FALLBACK"));
}

static uint64_t jobd_arg_wait_us(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_ARG_WAIT_US", 1000000ULL);
}

static bool jobd_force_devmem_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_FORCE_DEVMEM");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_cbo_inval_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CBO_INVAL");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_cbo_flush_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CBO_FLUSH");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static size_t jobd_cbo_block_bytes(void) {
    uint64_t value = parse_env_u64_default("HETGPU_SIFIVE_JOBD_CBO_BLOCK_BYTES", 64);
    if (value < 16) {
        value = 16;
    }
    if (value > 4096) {
...
static bool jobd_cbo_flush_opcode_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CBO_OP");
...
static bool jobd_drain_after_write_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_DRAIN_AFTER_WRITE");
    return value && env_flag_true(value);
}

static size_t jobd_drain_after_write_stride(void) {
    uint64_t value = parse_env_u64_default("HETGPU_SIFIVE_JOBD_DRAIN_AFTER_WRITE_STRIDE", 64);
    if (value == 0) value = 1;
...
static void jobd_evict_after_payload_write(void) {
    ...
    uint64_t requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_EVICT_AFTER_WRITE_BYTES", 0);
...
static bool jobd_rms_local_copy_enabled(void) {
    const char *value = getenv("SIFIVE_JOBD_RMS_LOCAL_COPY");
    if (value && *value) {
        return env_flag_true(value);
    }
    value = getenv("HETGPU_SIFIVE_JOBD_RMS_LOCAL_COPY");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_softmax_local_copy_enabled(void) {
    const char *value = getenv("SIFIVE_JOBD_SOFTMAX_LOCAL_COPY");
    if (value && *value) {
        return env_flag_true(value);
    }
    value = getenv("HETGPU_SIFIVE_JOBD_SOFTMAX_LOCAL_COPY");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_rms_rvv_enabled(void) {
    if (!env_flag_true(getenv("HETGPU_SIFIVE_JOBD_RMS_RVV_FORCE"))) {
        return false;
    }
    const char *value = getenv("HETGPU_SIFIVE_JOBD_RMS_RVV");
    if (value && *value) {
        return env_flag_true(value);
    }
    value = getenv("SIFIVE_JOBD_RMS_RVV");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_mmvf_copy_io_enabled(void) {
    const char *value = getenv("SIFIVE_JOBD_MMVF_COPY_IO");
    if (value && *value) {
        return env_flag_true(value);
    }
    value = getenv("HETGPU_SIFIVE_JOBD_MMVF_COPY_IO");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_mmvf_compute_enabled(void) {
    const char *value = getenv("SIFIVE_JOBD_MMVF_COMPUTE");
    if (value && *value) {
        return env_flag_true(value);
    }
    value = getenv("HETGPU_SIFIVE_JOBD_MMVF_COMPUTE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static bool jobd_mmvf_clear_dst_enabled(void) {
    const char *value = getenv("SIFIVE_JOBD_MMVF_CLEAR_DST");
    if (value && *value) {
        return env_flag_true(value);
    }
    value = getenv("HETGPU_SIFIVE_JOBD_MMVF_CLEAR_DST");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static unsigned jobd_mmvf_worker_threads(uint64_t work_items) {
    uint64_t requested = parse_env_u64_default("SIFIVE_JOBD_MMVF_THREADS", 0);
    if (requested == 0) {
        requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_MMVF_THREADS", 0);
    }
    if (requested == 0) {
        requested = parse_env_u64_default("SIFIVE_JOBD_KERNEL_THREADS", 0);
    }
    if (requested == 0) {
        requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_THREADS", 0);
    }
    if (requested == 0) {
        requested = SIFIVE_KERNEL_DEFAULT_THREADS;
    }
    if (requested > SIFIVE_KERNEL_MAX_THREADS) {
        requested = SIFIVE_KERNEL_MAX_THREADS;
    }
...
static bool jobd_heartbeat_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_HEARTBEAT");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_boot_marker_enabled(void) {
    return env_flag_true(getenv("HETGPU_SIFIVE_JOBD_BOOT_MARKER"));
}

static size_t jobd_helper_io_chunk_bytes(void) {
    uint64_t value = parse_env_u64_default("HETGPU_SIFIVE_JOBD_HELPER_IO_CHUNK_BYTES", 4096);
    if (value == 0) {
        return 1;
    }
...
static bool jobd_notify_irq_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_NOTIFY_IRQ");
    if (value && *value) {
        return env_flag_true(value);
    }
...
static bool jobd_seed_current_jobs_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_SEED_CURRENT_JOBS");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_claim_sifive_id_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_CLAIM_ID");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static bool jobd_xsfmm_smoke_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_XSFMM_SMOKE");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static uint64_t jobd_xsfmm_smoke_timeout_ms(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_XSFMM_SMOKE_TIMEOUT_MS", 200ULL);
}

static bool jobd_xsfmm_gemm_requested(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_XSFMM_GEMM");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
#if defined(HETGPU_SIFIVE_HAVE_XSFMM_BF16)
    return jobd_xsfmm_gemm_requested() &&
           g_xsfmm_bf16_checked &&
           g_xsfmm_bf16_usable;
#else
    return false;
#endif
...
static void emit_msg(const char *fmt, va_list ap) {
    ...
    fprintf(stderr, "hetgpu_sifive_jobd: %s\n", buf);
    if (jobd_kmsg_enabled()) {
        int kmsg = open("/dev/kmsg", O_WRONLY | O_CLOEXEC);
        if (kmsg >= 0) {
            dprintf(kmsg, "hetgpu_sifive_jobd: %s\n", buf);
            close(kmsg);
        }
    }
}
...
static void jobd_crash_handler(int sig, siginfo_t *info, void *uctx) {
    ...
    int len = snprintf(buf, sizeof(buf),
                       "hetgpu_sifive_jobd: fatal signal %d addr=%p pc=0x%" PRIxPTR
...
static bool jobd_fork_elf_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_FORK_ELF");
    if (value && *value) {
        return env_flag_true(value);
    }
    return true;
...
static uint64_t jobd_fork_elf_timeout_ms(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_FORK_ELF_TIMEOUT_MS", 5000ULL);
}

static int control_poll_timeout_ms(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_POLL_TIMEOUT_MS");
    char *end = NULL;
    long parsed;
    if (!value || !*value) {
        return 1;
...
static unsigned poll_irq_settle_us(void) {
    uint64_t value = parse_env_u64_default("HETGPU_SIFIVE_JOBD_POLL_IRQ_SETTLE_US", 1000);
    if (value > UINT_MAX) {
        return UINT_MAX;
    }
...
static int idle_sleep_us(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_IDLE_SLEEP_US");
    char *end = NULL;
    long parsed;
    if (!value || !*value) {
        return 1000;
...
static bool read_shared_ddr_info_from_env_or_debugfs(struct sifive_zluda_ddr_info *info) {
    uint64_t base = 0;
    uint64_t size = 0;
    if (!info) {
        return false;
    }
    parse_u64_checked(getenv("HETGPU_SIFIVE_SHARED_DDR_BASE"), &base);
    parse_u64_checked(getenv("HETGPU_SIFIVE_SHARED_DDR_BYTES"), &size);
    if (!size) {
        parse_u64_checked(getenv("HETGPU_SIFIVE_SHARED_DDR_SIZE"), &size);
    }
    if (!base) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_ddr_coh/shared_ddr_base", &base);
    }
    if (!base) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_ddr/shared_ddr_base", &base);
    }
    if (!base) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_full/shared_ddr_base", &base);
    }
    if (!base) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox/shared_ddr_base", &base);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_ddr_coh/shared_ddr_bytes", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_ddr_coh/shared_ddr_size", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_ddr/shared_ddr_bytes", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_ddr/shared_ddr_size", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_full/shared_ddr_bytes", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox_full/shared_ddr_size", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox/shared_ddr_bytes", &size);
    }
    if (!size) {
        read_u64_file("/sys/kernel/debug/hetgpu_sifive_mbox/shared_ddr_size", &size);
    }
    if (!base) {
        base = 0x20100600000ULL;
    }
    if (!size && base) {
        size = HETGPU_SIFIVE_DEFAULT_SHARED_DDR_BYTES;
    }
...
static int notify_zluda_irq(int mbox_fd) {
    ...
    struct sifive_zluda_ddr_info irq_info = g_ddr_info;
    jobd_io_fence();
    int ret = ioctl(mbox_fd, SIFIVE_IOC_ZLUDA_IRQ);
    int saved_errno;
    if (ret == 0) {
        jobd_io_fence();
        return 0;
    ...
    if (saved_errno == ENOTTY || saved_errno == EINVAL) {
        ret = ioctl(mbox_fd, SIFIVE_IOC_ZLUDA_IRQ_WITH_DDR, &irq_info);
        if (ret == 0) {
            jobd_io_fence();
            return 0;
        }
...
static void read_shared_ddr_info_from_mbox(int mbox_fd) {
    struct sifive_zluda_ddr_info fallback_info;
    bool have_fallback;
    (void)mbox_fd;
...
static void read_sifive_id_from_mbox(int mbox_fd) {
    const char *env = getenv("HETGPU_SIFIVE_ID");
    const char *legacy_env = getenv("SIFIVE_JOBD_SIFIVE_ID");
    (void)mbox_fd;
    if (parse_u64_checked(env, &g_sifive_id)) {
        log_msg("sifive id %" PRIu64 " from env", g_sifive_id);
        return;
    }
    if (parse_u64_checked(legacy_env, &g_sifive_id)) {
        log_msg("sifive id %" PRIu64 " from SIFIVE_JOBD_SIFIVE_ID", g_sifive_id);
        return;
    }
    g_sifive_id = 0;
    log_msg("sifive id defaulting to sifive0; skipped /dev/mbox sifive-id ioctl");
}

static bool claim_sifive_id_from_shared_ddr(int fd) {
    struct timespec ts = {0};
    uint64_t claim_token;

    if (!g_ddr_info.ddr_base ||
        g_ddr_info.ddr_size < HETGPU_SIFIVE_COUNT * HETGPU_SIFIVE_CONTROL_BYTES) {
        log_msg("cannot claim sifive id: shared DDR too small base=0x%" PRIx64
                " size=0x%" PRIx64,
                g_ddr_info.ddr_base, g_ddr_info.ddr_size);
        return false;
    }
    ...
    claim_token = HETGPU_SIFIVE_ID_CLAIM_MAGIC |
                  0x100ULL |
                  (((uint64_t)ts.tv_nsec ^ (uint64_t)(uintptr_t)&ts) & 0xffULL);

    for (uint32_t slot = 0; slot < HETGPU_SIFIVE_COUNT; slot++) {
        struct Map map = {0};
        uint64_t phys = g_ddr_info.ddr_base +
            (uint64_t)slot * HETGPU_SIFIVE_CONTROL_BYTES +
            HETGPU_SIFIVE_ID_CLAIM_OFF;
        if (map_phys(fd, phys, sizeof(uint64_t), &map) != 0) {
            log_msg("claim sifive id: map slot %u phys=0x%" PRIx64 " failed: %s",
        ...
        if (*claim == 0ULL) {
            *claim = claim_token;
            ...
            if (*claim == claim_token) {
                unmap_phys(&map);
                g_sifive_id = slot;
                log_msg("sifive id %" PRIu64 " claimed from shared DDR slot %u via store",
                        g_sifive_id, slot);
                return true;
            }
        }
        trace_msg("sifive id claim slot %u already owned by 0x%" PRIx64,
                  slot, *claim);
        unmap_phys(&map);
    }

    log_msg("failed to claim sifive id from shared DDR; keeping sifive id %" PRIu64,
            g_sifive_id);
    return false;
}

static uint64_t shared_ddr_control_phys(uint64_t off, size_t len) {
    uint64_t control_off = g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES + off;
    if (g_ddr_info.ddr_base &&
        control_off <= g_ddr_info.ddr_size &&
        (uint64_t)len <= g_ddr_info.ddr_size - control_off) {
        return g_ddr_info.ddr_base + control_off;
    }
    log_msg("shared DDR control access out of range: sifive_id=%" PRIu64 " off=0x%" PRIx64 " len=%zu base=0x%" PRIx64 " size=0x%" PRIx64,
            g_sifive_id, off, len, g_ddr_info.ddr_base, g_ddr_info.ddr_size);
    exit(EINVAL);
}
...
static const char *job_name(uint32_t job_id) {
    switch (job_id) {
    case SIFIVE_KERNEL_JOB_ID:
        return "KERNEL_ELF";
    case HETGPU_SIFIVE_JOB_GEMM:
        return "GEMM";
    case HETGPU_SIFIVE_JOB_SOFTMAX:
        return "SOFTMAX";
    case HETGPU_SIFIVE_JOB_RMSNORM:
        return "RMSNORM";
    case HETGPU_SIFIVE_JOB_ALLREDUCE:
        return "ALLREDUCE";
    case HETGPU_SIFIVE_JOB_MMVF:
        return "MMVF";
    default:
        return "UNKNOWN";
    }
...
static uint64_t hash_kernel_name_bytes(const char *name) {
    uint64_t hash = SIFIVE_FNV64_OFFSET;
    if (!name) return hash;
    for (const unsigned char *p = (const unsigned char *)name; *p; ++p) {
        hash ^= (uint64_t)*p;
        hash *= SIFIVE_FNV64_PRIME;
    }
    return hash;
}
...
static int map_phys(int fd, uint64_t phys, size_t len, struct Map *out) {
    ...
    mmap_addr = shared_ddr_sifive_phys(phys, len);
    uint64_t base = mmap_addr & ~(page - 1);
    size_t off = (size_t)(mmap_addr - base);
    size_t map_len = ((off + len + page - 1) / page) * page;
    void *p = mmap(NULL, map_len, PROT_READ | PROT_WRITE, MAP_SHARED, fd, (off_t)base);
    ...
    if (g_ddr_info.ddr_base && phys >= g_ddr_info.ddr_base) {
        ...
        if ((uint64_t)len <= g_ddr_info.ddr_size &&
            ...
            if (jobd_force_devmem_enabled() &&
                ...
                *out = shared_ddr_sifive_phys(phys, len);
                return true;
            }
...
static uint64_t shared_ddr_sifive_phys(uint64_t phys, size_t len) {
    if (g_shared_ddr_sifive_base && g_ddr_info.ddr_base &&
        phys_is_shared_ddr(phys, len)) {
        return g_shared_ddr_sifive_base + (phys - g_ddr_info.ddr_base);
    }
    return phys;
}
...
static bool phys_is_shared_ddr_control(uint64_t phys, size_t len) {
    ...
    uint64_t control_start = g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES;
    uint64_t ddr_off = phys - g_ddr_info.ddr_base;
    return ddr_off >= control_start &&
           ddr_off - control_start <= HETGPU_SIFIVE_CONTROL_BYTES - (uint64_t)len;
}
...
static int read_control_window_copy(uint64_t phys, size_t len, uint8_t **out) {
    ...
    control_phys = g_ddr_info.ddr_base + g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES;
    off = phys - control_phys;
    if (off > HETGPU_SIFIVE_CONTROL_BYTES ||
        (uint64_t)len > HETGPU_SIFIVE_CONTROL_BYTES - off) {
...
static int read_phys_copy_pread_only(int fd, uint64_t phys, size_t len, uint8_t **out) {
    ...
    if (phys_is_shared_ddr(phys, len)) {
        ...
        if (!phys_is_shared_ddr_control(phys, len) &&
            ddr_off <= UINT64_MAX - HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF) {
            uint64_t legacy_fd_off = HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF + ddr_off;
...
pread_fallback:
    ...
    if (phys_is_shared_ddr(phys, len)) {
        uint64_t ddr_off = phys - g_ddr_info.ddr_base;
        alt_fd_off = ddr_off;
        if (ddr_off <= UINT64_MAX - HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF) {
            uint64_t legacy_fd_off = HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF + ddr_off;
            if (legacy_fd_off != fd_off) {
                alt_fd_off = legacy_fd_off;
            }
...
static size_t shared_ddr_control_fd_candidates(uint64_t off,
    ...
    if (!candidates || candidate_max == 0 || len == 0 ||
        !g_ddr_info.ddr_base || g_sifive_id >= HETGPU_SIFIVE_COUNT) {
        return 0;
    }
    rel = g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES + off;
    ...
    if (HETGPU_SIFIVE_SHARED_DDR_USER_OFF <= UINT64_MAX - rel &&
        HETGPU_SIFIVE_SHARED_DDR_USER_OFF != g_shared_ddr_fd_user_off) {
        add_control_fd_candidate(candidates, &candidate_count, candidate_max,
                                 HETGPU_SIFIVE_SHARED_DDR_USER_OFF + rel);
    }
...
static int read_shared_ddr_control_copy_pread_for_sifive(int fd,
                                                       uint32_t sifive_id,
                                                       uint64_t off,
                                                       size_t len,
                                                       uint8_t **out) {
    ...
    if (!jobd_control_pread_enabled() ||
        ...
        sifive_id >= HETGPU_SIFIVE_COUNT) {
        return -1;
    }
    rel = (uint64_t)sifive_id * HETGPU_SIFIVE_CONTROL_BYTES + off;
    if (rel > g_ddr_info.ddr_size || (uint64_t)len > g_ddr_info.ddr_size - rel) {
        return -1;
    }
...
static int write_phys_copy_pwrite_only(int fd, uint64_t phys, const void *src, size_t len) {
    ...
    jobd_io_fence();
    const char *dual_offset = getenv("HETGPU_SIFIVE_JOBD_DUAL_OFFSET_WRITE");
...
static void write_jobd_beacon(int fd, uint32_t job_id, uint64_t seq, uint32_t phase, uint32_t detail) {
    struct JobdBeacon beacon = {
        .magic = HETGPU_SIFIVE_BEACON_MAGIC,
    ...
    phys = shared_ddr_control_phys(HETGPU_SIFIVE_BEACON_OFF, sizeof(beacon));
    jobd_io_fence();
...
static int write_phys_copy_chunked(int fd,
    ...
    while (done < len) {
        ...
        if (env_flag_true(getenv("HETGPU_SIFIVE_JOBD_SYNC_WRITE_CHUNKS"))) {
...
static void repair_shared_ddr_writeback(int fd,
    ...
    const char *enabled = getenv("HETGPU_SIFIVE_JOBD_REPAIR_WRITEBACK");
    ...
    attempts = parse_env_u64_default("HETGPU_SIFIVE_JOBD_REPAIR_WRITEBACK_ATTEMPTS", 32);
    if (attempts > 256) attempts = 256;
    sleep_us = parse_env_u64_default("HETGPU_SIFIVE_JOBD_REPAIR_WRITEBACK_SLEEP_US", 0);
    if (sleep_us > 1000000) sleep_us = 1000000;
    requested_chunk = parse_env_u64_default("HETGPU_SIFIVE_JOBD_REPAIR_WRITEBACK_CHUNK_BYTES", 4096);
...
static void clear_stale_control_region(int fd, struct Map *control_map) {
    uint8_t zeros[HETGPU_SIFIVE_CONTROL_BYTES];
    uint64_t phys;
...
static int read_control_snapshot(int fd, void *out, size_t len) {
    uint8_t *copy = NULL;
    uint64_t phys;
    if (!out || len == 0 || len > HETGPU_SIFIVE_CONTROL_BYTES) {
        return -1;
    }
     ...
     * current SIFIVE Linux image /dev/mem mappings can lag one IRQ behind, so a
...
static bool read_mbox_kernel_desc(int mbox_fd, struct SifiveJobDesc *desc) {
    struct SifiveJobDesc tmp;
    ssize_t got;
    ...
    if (tmp.buf_info != SIFIVE_JOB_MAGIC || tmp.seq == 0 || tmp.addr == 0 || tmp.len == 0) {
        return false;
    }
    *desc = tmp;
    return true;
...
static bool probe_shared_ddr_mmap(int fd) {
    const char *configured = getenv("HETGPU_SIFIVE_SHARED_DDR_MMAP_USER_OFF");
    ...
    /*
     * /dev/sifive shared-DDR mmap is DDR-relative in the AP-visible driver.  Probe
    ...
    if ((!configured || !*configured) &&
        probe_shared_ddr_mmap_at(fd, HETGPU_SIFIVE_SHARED_DDR_USER_OFF)) {
        return true;
    }
    if (configured_off != HETGPU_SIFIVE_SHARED_DDR_USER_OFF &&
        probe_shared_ddr_mmap_at(fd, HETGPU_SIFIVE_SHARED_DDR_USER_OFF)) {
        return true;
    }
...
static int load_jobs_config(const char *path, struct PreloadedJobs *jobs) {
    ...
    while (fgets(line, sizeof(line), f)) {
        ...
        if (!strcmp(op, "gemm")) {
            ...
            memset(j, 0, sizeof(*j));
            j->atype = SIFIVE_DTYPE_F32;
            j->btype = SIFIVE_DTYPE_F32;
            j->ctype = SIFIVE_DTYPE_F32;
            j->m = parse_u64(tok[1]);
            j->n = parse_u64(tok[2]);
            j->k = parse_u64(tok[3]);
...
static int arg_slot_for_job(uint32_t job_id) {
    switch (job_id) {
    case HETGPU_SIFIVE_JOB_GEMM: return 0;
    case HETGPU_SIFIVE_JOB_SOFTMAX: return 1;
    case HETGPU_SIFIVE_JOB_RMSNORM: return 2;
    case HETGPU_SIFIVE_JOB_ALLREDUCE: return 3;
    case HETGPU_SIFIVE_JOB_MMVF: return 4;
    default: return -1;
    }
}

static bool preloaded_job_seen(uint32_t job_id, uint64_t seq) {
    return job_id < HETGPU_SIFIVE_MAX_JOB_ID &&
           seq != 0 &&
           seq == g_last_preloaded_seq_by_job[job_id];
}

static void mark_preloaded_job_seen(uint32_t job_id, uint64_t seq) {
    if (job_id < HETGPU_SIFIVE_MAX_JOB_ID &&
        seq > g_last_preloaded_seq_by_job[job_id]) {
...
static bool arg_slot_header_valid(uint32_t job_id, const struct ArgSlotHeader *header) {
    return header &&
           header->magic == HETGPU_SIFIVE_JOB_MAGIC &&
           header->version == HETGPU_SIFIVE_JOB_VERSION &&
           (header->job_id == job_id || header->job_id == 0) &&
           header->seq != 0 &&
           header->arg_len <= HETGPU_SIFIVE_ARG_SLOT_BYTES - sizeof(*header);
}
...
static uint32_t arg_slot_header_valid_bits(uint32_t job_id, const struct ArgSlotHeader *header) {
    ...
    return (header->magic == HETGPU_SIFIVE_JOB_MAGIC ? 0x1u : 0u) |
           (header->version == HETGPU_SIFIVE_JOB_VERSION ? 0x2u : 0u) |
           ((header->job_id == job_id || header->job_id == 0) ? 0x4u : 0u) |
           (header->arg_len <= HETGPU_SIFIVE_ARG_SLOT_BYTES - sizeof(*header) ? 0x8u : 0u) |
...
static bool arg_slot_header_copy(int fd, uint32_t job_id, struct ArgSlotHeader *out) {
    ...
    slot_off = HETGPU_SIFIVE_ARG_BASE_OFF + (uint64_t)slot * HETGPU_SIFIVE_ARG_SLOT_BYTES;
...
static bool find_pending_arg_slot_job(int fd, struct ArgSlotHeader *best_out) {
    static const uint32_t job_ids[] = {
        HETGPU_SIFIVE_JOB_GEMM,
        HETGPU_SIFIVE_JOB_SOFTMAX,
        HETGPU_SIFIVE_JOB_RMSNORM,
        HETGPU_SIFIVE_JOB_ALLREDUCE,
        HETGPU_SIFIVE_JOB_MMVF,
    };
    struct ArgSlotHeader best;
    uint32_t best_candidate = 0xffffffffu;
    uint32_t best_sifive_id = UINT32_MAX;
    ...
    {
    uint32_t preferred = g_sifive_id < HETGPU_SIFIVE_COUNT ? (uint32_t)g_sifive_id : 0U;
    uint32_t scan_count = jobd_arg_slot_scan_all_sifive_enabled() ? HETGPU_SIFIVE_COUNT : 1U;

    for (uint32_t sifive_iter = 0; sifive_iter < scan_count; sifive_iter++) {
        uint32_t sifive = (preferred + sifive_iter) % HETGPU_SIFIVE_COUNT;
        for (size_t i = 0; i < sizeof(job_ids) / sizeof(job_ids[0]); i++) {
            ...
            mirror_diag_event(fd, job_id, 0, 0x52010000u | job_id,
                              (sifive << 8) | (uint32_t)i);
            if (read_shared_ddr_control_copy_pread_for_sifive(fd, sifive, slot_off,
                                                            sizeof(header),
                                                            &slot_bytes) != 0) {
                uint64_t phys = g_ddr_info.ddr_base +
                    (uint64_t)sifive * HETGPU_SIFIVE_CONTROL_BYTES + slot_off;
                if (read_phys_copy(fd, phys, sizeof(header), &slot_bytes) != 0) {
    ...
    g_pending_arg_header_sifive_id = best_sifive_id;
...
static void select_sifive_id_from_arg_slot_candidate(uint32_t candidate,
                                                   uint32_t job_id,
                                                   uint64_t seq) {
    if (candidate >= HETGPU_SIFIVE_COUNT) {
        return;
    }
    if (g_sifive_id == candidate) {
        return;
    }
    if (getenv("HETGPU_SIFIVE_ID") || getenv("SIFIVE_JOBD_SIFIVE_ID")) {
        trace_msg("ignoring arg-slot sifive id switch to %u while HETGPU_SIFIVE_ID is fixed", candidate);
        return;
    }

    log_msg("switching sifive id from %" PRIu64 " to %u from arg-slot job_id=%u/%s seq=%" PRIu64,
            g_sifive_id, candidate, job_id, job_name(job_id), seq);
    g_sifive_id = candidate;
    /*
     * The direct control-window mmap was created for the old g_sifive_id.  Once
...
static size_t dtype_size(uint32_t dtype) {
    switch (dtype) {
    case SIFIVE_DTYPE_INT8:
        return sizeof(int8_t);
    case SIFIVE_DTYPE_UINT8:
        return sizeof(uint8_t);
    case SIFIVE_DTYPE_INT32:
        return sizeof(int32_t);
    case SIFIVE_DTYPE_F16:
        return sizeof(uint16_t);
    case SIFIVE_DTYPE_F32:
        return sizeof(float);
    case SIFIVE_DTYPE_BF16:
        return sizeof(uint16_t);
    default:
        return 0;
    }
...
static void run_xsfmm_smoke_if_requested(void) {
    ...
    if (verbose || requested) {
        log_msg("xsfmm unavailable in this jobd image; using BF16 staged GEMM");
    }
    return;
#else
    pid_t pid = fork();
    ...
    for (;;) {
        ...
        if (got == pid) {
            if (WIFEXITED(status)) {
                ...
                g_xsfmm_bf16_usable = code == 0;
                if (verbose || !g_xsfmm_bf16_usable) {
                    log_msg("xsfmm smoke exit=%d usable=%d", code,
                            g_xsfmm_bf16_usable ? 1 : 0);
                }
            } else if (WIFSIGNALED(status)) {
                log_msg("xsfmm smoke signal=%d; using BF16 staged GEMM",
                        WTERMSIG(status));
            }
            return;
        }
        ...
        if (timeout_ms != 0 && monotonic_us() >= deadline) {
            ...
            log_msg("xsfmm smoke timed out after %" PRIu64
                    " ms; using BF16 staged GEMM", timeout_ms);
            return;
        }
        sleep_us(1000);
    }
...
static void mirror_rmsnorm_debug_sample(int fd,
    ...
    dbg.magic = HETGPU_SIFIVE_RMS_DEBUG_MAGIC;
    dbg.version = HETGPU_SIFIVE_JOB_VERSION;
    dbg.sifive_id = (uint32_t)g_sifive_id;
    dbg.phase = phase;
    dbg.dtype = job->dtype;
    dbg.seq = seq;
    dbg.row = 0;
...
static float SIFIVE_RVV_UNUSED gemm_dot_f32_scalar(const float *a, ptrdiff_t a_stride,
...
static float gemm_dot_typed(const void *a, uint32_t atype, ptrdiff_t a_stride,
                            ...
                            uint64_t k) {
    if (atype == SIFIVE_DTYPE_F32 && btype == SIFIVE_DTYPE_F32) {
...
static bool gemm_dtype_uses_xsfmm32a16f(uint32_t dtype) {
    return dtype == SIFIVE_DTYPE_BF16 || dtype == SIFIVE_DTYPE_F16;
}
...
static int gemm_select_notrans_tile_config(const struct GemmJob *job,
    ...
    if (job->atype == SIFIVE_DTYPE_BF16 && job->btype == SIFIVE_DTYPE_BF16 &&
        job->ctype == SIFIVE_DTYPE_BF16 && job->n <= 4) {
        return 0;
    }
    ...
    if (gemm_dtype_uses_xsfmm32a16f(job->atype) &&
        ...
        *cfg = (struct GemmTileConfig){
            .tile_m = SIFIVE_XSFMM16_TILE_M,
            .tile_n = SIFIVE_XSFMM16_TILE_N,
            .tile_k = SIFIVE_XSFMM16_TILE_K,
            .name = job->atype == SIFIVE_DTYPE_BF16
                ? "xsfmm32a16f-bf16"
    ...
    if (job->atype == SIFIVE_DTYPE_F32 &&
        job->btype == SIFIVE_DTYPE_F32 &&
        job->ctype == SIFIVE_DTYPE_F32) {
        *cfg = (struct GemmTileConfig){
            .tile_m = SIFIVE_RVV_F32_TILE_M,
            .tile_n = SIFIVE_RVV_F32_TILE_N,
            .tile_k = SIFIVE_RVV_F32_TILE_K,
            .name = "rvv-f32-soft",
        };
        return 1;
    }
...
static void gemm_accumulate_rowmajor_outer_tile(const struct GemmJob *job,
    ...
    if (jobd_xsfmm_gemm_enabled() &&
        job->atype == SIFIVE_DTYPE_BF16 && job->btype == SIFIVE_DTYPE_BF16 &&
        k1 - k0 == 4) {
...
static int gemm_try_notrans_tiled_worker(const struct GemmWorker *w) {
    ...
    if (cfg.tile_m > SIFIVE_GEMM_TILE_M_MAX || cfg.tile_n > SIFIVE_GEMM_TILE_N_MAX ||
    ...
    for (uint64_t row0 = w->row_begin; row0 < row_end; row0 += cfg.tile_m) {
        ...
        for (uint64_t col0 = 0; col0 < job->n; col0 += cfg.tile_n) {
            ...
            float acc[SIFIVE_GEMM_TILE_M_MAX * SIFIVE_GEMM_TILE_N_MAX];
...
static uint64_t jobd_gemm_single_thread_ops_threshold(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_GEMM_SINGLE_THREAD_OPS", 0);
}

static unsigned jobd_gemm_worker_threads(void) {
    uint64_t requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_GEMM_THREADS", 0);
    if (requested == 0) {
        requested = parse_env_u64_default("SIFIVE_JOBD_GEMM_THREADS", 0);
    }
    if (requested == 0) {
        requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_THREADS", 0);
    }
    ...
    if (requested == 0) {
        requested = SIFIVE_GEMM_THREADS;
    }
    if (requested > SIFIVE_GEMM_THREADS) {
        requested = SIFIVE_GEMM_THREADS;
    }
    if (requested < 1) {
        requested = 1;
...
static int run_gemm_matrix_threads(const struct GemmJob *job, const void *a,
    ...
    pthread_t threads[SIFIVE_GEMM_THREADS];
    struct GemmWorker workers[SIFIVE_GEMM_THREADS];
    ...
    if ((threshold != 0 && ops <= threshold) ||
        nthreads <= 1 ||
        (!xsfmm_row_threading && job->m < SIFIVE_GEMM_THREADS)) {
...
static bool gemm_bf16_skinny_copy_path(const struct GemmJob *job) {
    return job && gemm_job_is_compact_rowmajor(job) &&
           job->atype == SIFIVE_DTYPE_BF16 &&
           job->btype == SIFIVE_DTYPE_BF16 &&
           job->ctype == SIFIVE_DTYPE_BF16 &&
           job->n > 0 && job->n <= 4;
}
...
static int run_gemm_bf16_skinny_copy(int fd,
    ...
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x51230001u);
    for (uint64_t row = 0; row < job->m; row++) {
        if ((row & 0x3fu) == 0) {
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq,
    ...
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x5123ffffu);
    return 0;
}

static int run_gemm(int fd, const struct GemmJob *job, uint64_t seq) {
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x5120);
    ...
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x5121);
    ...
    if (jobd_gemm_copy_io_enabled()) {
        ...
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x5122);
        for (uint64_t batch = 0; batch < batch_count; batch++) {
            ...
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x5123);
        ...
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x5124);
        if (status == 0) {
            /*
             * Publish C through the SIFIVE shared-DDR alias first.  The fd/pwrite
             * path can block inside the SIFIVE-side jobd, so it is only a
             * fallback when the direct alias mapping itself fails.
             */
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x512401);
            ...
            if (mapped_status != 0) {
                status = 0xffff1005;
            } else if (env_flag_true(getenv("HETGPU_SIFIVE_JOBD_GEMM_LINE_PWRITE"))) {
            ...
            if (status == 0) {
                repair_shared_ddr_writeback(fd, job->c_addr, c_copy, c_bytes, "gemm-output");
                {
                    uint64_t wait_us = parse_env_u64_default(
                        "HETGPU_SIFIVE_JOBD_GEMM_OUTPUT_VISIBLE_WAIT_US", 0ULL);
                    uint64_t sleep_step = parse_env_u64_default(
                        "HETGPU_SIFIVE_JOBD_GEMM_OUTPUT_VISIBLE_SLEEP_US", 100ULL);
                    uint64_t deadline = monotonic_us() + wait_us;
                    bool visible = false;
                    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_GEMM, seq, 0x512407);
                    do {
                    ...
                    if (!visible && env_flag_true(getenv("HETGPU_SIFIVE_JOBD_GEMM_STRICT_VISIBLE"))) {
                        status = 0xffff1005;
                    }
                }
            }
...
static int run_softmax(int fd, const struct SoftmaxJob *job, uint64_t seq) {
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_SOFTMAX, seq, 0x5220);
    ...
    if (jobd_softmax_local_copy_enabled()) {
        ...
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_SOFTMAX, seq, 0x5221);
        if (read_phys_copy(fd, job->src_addr, bytes, &src_copy) != 0 || !src_copy) {
            free(src_copy);
            return 0xffff2101;
        }
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_SOFTMAX, seq, 0x5222);
        ...
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_SOFTMAX, seq, 0x5223);
        ...
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_SOFTMAX, seq, 0x5224);
        return 0;
    }
    struct Map ms = {0}, md = {0};
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_SOFTMAX, seq, 0x5228);
...
static int run_rmsnorm(int fd, const struct RmsNormJob *job, uint64_t seq) {
    ...
    if (jobd_rms_local_copy_enabled()) {
        ...
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0x5120);
        if (read_phys_copy(fd, job->x_addr, data_bytes, &x_local) == 0) {
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0x5121);
            if (job->weight_addr) {
                if (read_phys_copy(fd, job->weight_addr, weight_bytes, &w_local) == 0) {
                    have_weight = true;
                    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0x5122);
                } else {
                    free(x_local);
                    x_local = NULL;
                }
        ...
        if (x_local) {
            ...
            bool used_rvv = false;
            if (job->dtype == SIFIVE_DTYPE_F32 && jobd_rms_rvv_enabled()) {
            ...
            mirror_rmsnorm_debug_sample(fd, job, seq, x_local,
                                        ...
                                        4u |
                                        (used_rvv ? 8u : 0u));
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0x5123);
            bool output_pwrite = jobd_rms_output_pwrite_enabled();
            int write_status = 0;
            unsigned write_attempts =
                (unsigned)parse_env_u64_default("HETGPU_SIFIVE_JOBD_RMS_WRITE_ATTEMPTS", 1);
            ...
            for (unsigned attempt = 0; attempt < write_attempts; attempt++) {
                write_status = output_pwrite
                    ? write_phys_copy_chunked_pwrite_only(
                          ...
                          y_local,
                          data_bytes,
                          "HETGPU_SIFIVE_JOBD_RMS_WRITE_CHUNK_BYTES")
            ...
            if (write_status == 0) {
                uint64_t sync_attempts = parse_env_u64_default(
                    "HETGPU_SIFIVE_JOBD_RMS_OUTPUT_SYNC_ATTEMPTS", 0);
            ...
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0x5124);
    ...
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0x5128);
...
static int run_allreduce(int fd, const struct AllReduceJob *job) {
    ...
    if (job->dtype != SIFIVE_DTYPE_F32 || job->reduce_op != 0) return 0xffff4002;
...
static int compile_kernel_c_object(const char *src, const char *obj) {
    const char *env_cc = getenv("HETGPU_SIFIVE_DEVICE_CC");
...
static size_t kernel_tmp_shared_stub_bytes(void) {
    const char *env = getenv("HETGPU_SIFIVE_KERNEL_TMP_SHARED_BYTES");
    if (env && *env) {
        char *end = NULL;
...
static int build_kernel_tmp_shared_stubs(const char *input_obj,
    ...
    fprintf(out, "__attribute__((used)) static unsigned char hetgpu_sifive_tmp_shared_anchor;\n");
...
static const char *find_riscv_builtins_archive(void) {
    const char *env = getenv("HETGPU_SIFIVE_DEVICE_BUILTINS");
...
static int device_link_kernel_object(const char *input_obj, const char *output_so) {
    const char *env_linker = getenv("HETGPU_SIFIVE_DEVICE_LINKER");
...
static bool elf64_locate_symbol_by_hash(const uint8_t *elf, size_t elf_len,
    ...
    for (uint16_t i = 0; i < shnum; i++) {
        ...
        if (shtype != SIFIVE_ELF_SHT_SYMTAB && shtype != SIFIVE_ELF_SHT_DYNSYM) continue;
        ...
        if (read_u32_le(str_sh + 0x04) != SIFIVE_ELF_SHT_STRTAB) continue;
        ...
        for (size_t sym_idx = 0; sym_idx < sym_count; sym_idx++) {
            ...
            if (st_type != SIFIVE_ELF_STT_FUNC && st_type != SIFIVE_ELF_STT_NOTYPE) continue;
            ...
            if (st_type == SIFIVE_ELF_STT_FUNC && !fallback) fallback = name;
        }
    }
...
static int load_kernel_elf_direct(const uint8_t *elf, size_t elf_len,
    ...
    if (!elf || !out || elf64_type(elf, elf_len) != SIFIVE_ELF_ET_DYN) {
    ...
    for (uint16_t i = 0; i < phnum; i++) {
        ...
        if (type != SIFIVE_ELF_PT_LOAD) continue;
    ...
    for (uint16_t i = 0; i < shnum; i++) {
        ...
        if (read_u32_le(rela_sh + 0x04) != SIFIVE_ELF_SHT_RELA) continue;
        ...
        if (symtab_index < shnum) {
            ...
            if (strtab_index < shnum) {
                ...
                if (read_u32_le(str_sh + 0x04) == SIFIVE_ELF_SHT_STRTAB &&
        ...
        for (size_t r = 0; r < rela_count; r++) {
            ...
            uint64_t value = 0;
            if (r_type == SIFIVE_R_RISCV_RELATIVE) {
                value = (uint64_t)(load_bias + (uintptr_t)r_addend);
            } else if (r_type == SIFIVE_R_RISCV_64 || r_type == SIFIVE_R_RISCV_JUMP_SLOT) {
    ...
    if (elf64_find_symbol_value(elf, elf_len, "f___zluda_ptx_impl_set_launch", &sym_value)) {
        out->set_launch = (SifiveSetLaunchFn)(uintptr_t)(load_bias + (uintptr_t)sym_value);
    }
...
static void unload_kernel_image(struct LoadedKernelImage *loaded) {
    ...
    if (loaded->direct && loaded->mapping && loaded->map_len) {
        /*
         * Keep direct ELF mappings resident.  On the SIFIVE-side Linux jobd this
...
static bool kernel_cache_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_KERNEL_CACHE");
...
static const char *kernel_cache_dir(void) {
    const char *value = getenv("HETGPU_SIFIVE_KERNEL_CACHE_DIR");
    return (value && *value) ? value : "/tmp/hetgpu_sifive_kernel_cache";
}
...
static int load_kernel_image(const uint8_t *elf, size_t elf_len,
    ...
    char tmpdir[] = "/tmp/hetgpu_sifive_kernelXXXXXX";
    ...
    } else if (e_type == SIFIVE_ELF_ET_DYN) {
        snprintf(so_path, sizeof(so_path), "%s/kernel.so", tmpdir);
...
static struct SifiveUint3 kernel_arg_uint3(const uint64_t *args,
                                         const struct SifiveJobImage *job,
                                         size_t index) {
    struct SifiveUint3 v;
...
static int SIFIVE_UNUSED invoke_kernel_bin_bcast23(void *fn,
                                                 const uint64_t *args,
                                                 const struct SifiveJobImage *job) {
    struct SifiveUint3 u3_6 = kernel_arg_uint3(args, job, 6);
    struct SifiveUint3 u3_7 = kernel_arg_uint3(args, job, 7);
    struct SifiveUint3 u3_8 = kernel_arg_uint3(args, job, 8);
    struct SifiveUint3 u3_9 = kernel_arg_uint3(args, job, 9);
    struct SifiveUint3 u3_10 = kernel_arg_uint3(args, job, 10);
    typedef void (*BinBcast23Fn)(
        const void *, const void *, void *,
        int32_t, int32_t, int32_t,
        struct SifiveUint3, struct SifiveUint3, struct SifiveUint3,
        struct SifiveUint3, struct SifiveUint3,
...
static uint32_t sifive_nonzero_dim(uint32_t value) {
...
static unsigned kernel_worker_threads(uint64_t total_threads) {
    uint64_t requested = parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_THREADS", 0);
    unsigned default_threads = SIFIVE_KERNEL_DEFAULT_THREADS;
...
static uint64_t scale_f32_single_thread_max_elements(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_SCALE_F32_SINGLE_THREAD_MAX_ELEMS",
                                 8192ULL);
}

enum SifiveBinBcastOp {
    SIFIVE_BIN_BCAST_UNSUPPORTED = 0,
    SIFIVE_BIN_BCAST_REPEAT,
    SIFIVE_BIN_BCAST_ADD,
    SIFIVE_BIN_BCAST_SUB,
    SIFIVE_BIN_BCAST_MUL,
    SIFIVE_BIN_BCAST_DIV,
};
...
struct BinBcastNativeCtx {
    ...
    int32_t ne1;
    int32_t ne2;
    struct SifiveUint3 ne3;
    struct SifiveUint3 ne10;
    struct SifiveUint3 ne11;
    struct SifiveUint3 ne12;
    struct SifiveUint3 ne13;
    int32_t s1;
    int32_t s2;
    int32_t s3;
    int32_t s00;
    ...
    int32_t s12;
    int32_t s13;
    const float *src1s[SIFIVE_MAX_KERNEL_ARGS];
    size_t src1s_count;
    enum SifiveBinBcastOp op;
};
...
static uint64_t kernel_binding_size_for_arg(const struct SifiveJobImage *job,
                                            uint32_t arg_index);

static enum SifiveBinBcastOp bin_bcast_op_from_symbol(const char *symbol) {
    if (!symbol) return SIFIVE_BIN_BCAST_UNSUPPORTED;
    if (strstr(symbol, "op_repeatff")) return SIFIVE_BIN_BCAST_REPEAT;
    if (strstr(symbol, "op_addff")) return SIFIVE_BIN_BCAST_ADD;
    if (strstr(symbol, "op_subff")) return SIFIVE_BIN_BCAST_SUB;
    if (strstr(symbol, "op_mulff")) return SIFIVE_BIN_BCAST_MUL;
    if (strstr(symbol, "op_divff")) return SIFIVE_BIN_BCAST_DIV;
    return SIFIVE_BIN_BCAST_UNSUPPORTED;
}
...
static struct SifiveUint3 kernel_cell_u3(const uint64_t *argv, size_t argc, size_t index) {
    const struct KernelParamCell *cell = kernel_argv_cell(argv, argc, index);
    struct SifiveUint3 v = {0, 0, 0};
    if (!cell) return v;
...
static int invoke_kernel_pytorch_fill_native(const char *symbol,
                                             ...
                                             const struct SifiveJobImage *job,
                                             size_t argc) {
    if (!symbol || strcmp(symbol, "sifive_pytorch_fill_pattern") != 0) {
        return 1;
    }
    if (!job || argc < 4) {
        return -1;
...
static uint32_t bin_bcast_fast_dim(struct SifiveUint3 v) {
    return v.z ? v.z : 1u;
}

static float bin_bcast_apply(enum SifiveBinBcastOp op, float a, float b) {
    switch (op) {
    case SIFIVE_BIN_BCAST_REPEAT: return b;
    case SIFIVE_BIN_BCAST_ADD: return a + b;
    case SIFIVE_BIN_BCAST_SUB: return a - b;
    case SIFIVE_BIN_BCAST_MUL: return a * b;
    case SIFIVE_BIN_BCAST_DIV: return a / b;
    default: return a;
    }
}
...
#if defined(__riscv_vector)
static inline vfloat32m4_t bin_bcast_apply_vec_vv(enum SifiveBinBcastOp op,
                                                  vfloat32m4_t a,
                                                  vfloat32m4_t b,
                                                  size_t vl) {
    switch (op) {
    case SIFIVE_BIN_BCAST_REPEAT: return b;
    case SIFIVE_BIN_BCAST_ADD: return __riscv_vfadd_vv_f32m4(a, b, vl);
    case SIFIVE_BIN_BCAST_SUB: return __riscv_vfsub_vv_f32m4(a, b, vl);
    case SIFIVE_BIN_BCAST_MUL: return __riscv_vfmul_vv_f32m4(a, b, vl);
    case SIFIVE_BIN_BCAST_DIV: return __riscv_vfdiv_vv_f32m4(a, b, vl);
    default: return a;
    }
}

static inline vfloat32m4_t bin_bcast_apply_vec_vf(enum SifiveBinBcastOp op,
                                                  vfloat32m4_t a,
                                                  float b,
                                                  size_t vl) {
    switch (op) {
    case SIFIVE_BIN_BCAST_REPEAT: return __riscv_vfmv_v_f_f32m4(b, vl);
    case SIFIVE_BIN_BCAST_ADD: return __riscv_vfadd_vf_f32m4(a, b, vl);
    case SIFIVE_BIN_BCAST_SUB: return __riscv_vfsub_vf_f32m4(a, b, vl);
    case SIFIVE_BIN_BCAST_MUL: return __riscv_vfmul_vf_f32m4(a, b, vl);
    case SIFIVE_BIN_BCAST_DIV: return __riscv_vfdiv_vf_f32m4(a, b, vl);
    default: return a;
    }
}
...
static bool bin_bcast_native_row_rvv(const struct BinBcastNativeCtx *ctx,
    ...
    if (ctx->op == SIFIVE_BIN_BCAST_UNSUPPORTED) return false;
    ...
    if (ctx->op != SIFIVE_BIN_BCAST_REPEAT && !src0_row) return false;
...
static int invoke_kernel_bin_bcast_native(const char *symbol,
    ...
    if (!env_flag_default_true("HETGPU_SIFIVE_ENABLE_NATIVE_BIN_BCAST")) return 1;
    if (strstr(symbol, "k_bin_bcast_unravel")) return 1;
    if (!strstr(symbol, "EEfffJ")) return 1;
    if (argc < 22 || argc > SIFIVE_MAX_KERNEL_ARGS) return (int)0xffffb001u;

    struct BinBcastNativeCtx ctx;
    memset(&ctx, 0, sizeof(ctx));
    ctx.op = bin_bcast_op_from_symbol(symbol);
    if (ctx.op == SIFIVE_BIN_BCAST_UNSUPPORTED) return 1;
    ...
    void *local_dst = NULL;
    void *local_src1s[SIFIVE_MAX_KERNEL_ARGS];
    memset(local_src1s, 0, sizeof(local_src1s));

    uint64_t local_max = parse_env_u64_default("SIFIVE_JOBD_BIN_BCAST_LOCAL_MAX_BYTES",
                                               1u << 20);
    if (local_max != 0) {
    ...
    if (workers <= 1 || rows <= 1) {
        ...
        pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
        struct BinBcastNativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
        unsigned created = 0;
...
enum SifiveMmvfXType {
    SIFIVE_MMVF_UNSUPPORTED = 0,
    SIFIVE_MMVF_F32,
    SIFIVE_MMVF_F16,
    SIFIVE_MMVF_BF16,
    SIFIVE_MMVF_Q8_0,
...
struct MmvfNativeCtx {
    ...
    uint32_t grid_z;
    uint32_t ncols_dst;
    enum SifiveMmvfXType x_type;
    enum SifiveMmvfXType y_type;
};
...
static pthread_once_t SIFIVE_UNUSED g_f16_table_once = PTHREAD_ONCE_INIT;
static float g_f16_to_f32[65536];
static volatile int g_f16_table_ready;

static float sifive_f16_bits_to_f32(uint16_t h) {
...
static void SIFIVE_UNUSED sifive_f16_table_init_once(void) {
    for (uint32_t i = 0; i <= UINT16_MAX; i++) {
        g_f16_to_f32[i] = sifive_f16_bits_to_f32((uint16_t)i);
    }
    __sync_synchronize();
    g_f16_table_ready = 1;
}

static void sifive_prepare_f16_table(void) {
#if defined(__riscv_zfh) || defined(__riscv_zfhmin)
    g_f16_table_ready = 1;
#else
    pthread_once(&g_f16_table_once, sifive_f16_table_init_once);
#endif
}

static float sifive_f16_to_f32(uint16_t h) {
#if defined(__riscv_zfh) || defined(__riscv_zfhmin)
    return sifive_f16_bits_to_f32(h);
#else
...
static float sifive_bf16_to_f32(uint16_t h) {
...
static enum SifiveMmvfXType mmvf_type_from_symbol(const char *symbol) {
    if (!symbol || !strstr(symbol, "mul_mat_vec_f")) return SIFIVE_MMVF_UNSUPPORTED;
    if (strstr(symbol, "mul_mat_vec_fI6__half")) return SIFIVE_MMVF_F16;
    if (strstr(symbol, "mul_mat_vec_fIff")) return SIFIVE_MMVF_F32;
    return SIFIVE_MMVF_UNSUPPORTED;
}

static enum SifiveMmvfXType mmvf_type_from_job_field(uint32_t value) {
    switch (value) {
    case 2:
        return SIFIVE_MMVF_F16;
    case 3:
        return SIFIVE_MMVF_BF16;
    case 0:
    case 1:
    default:
        return SIFIVE_MMVF_F32;
    }
}

static size_t mmvf_type_size(enum SifiveMmvfXType type) {
    if (type == SIFIVE_MMVF_F16 || type == SIFIVE_MMVF_BF16) {
        return sizeof(uint16_t);
    }
    if (type == SIFIVE_MMVF_Q8_0) {
        return 1;
    }
    return sizeof(float);
}

static const struct SifiveKernelBufferBinding *kernel_binding_for_arg(const struct SifiveJobImage *job,
                                                                    uint32_t arg_index) {
...
static uint64_t kernel_binding_size_for_arg(const struct SifiveJobImage *job, uint32_t arg_index) {
    const struct SifiveKernelBufferBinding *binding = kernel_binding_for_arg(job, arg_index);
    return binding ? binding->size : 0;
}

static bool kernel_binding_phys_size_for_arg(const struct SifiveJobImage *job,
                                             uint32_t arg_index,
                                             uint64_t *phys,
                                             size_t *size) {
    const struct SifiveKernelBufferBinding *binding = kernel_binding_for_arg(job, arg_index);
...
static size_t kernel_binding_map_bytes(const struct SifiveKernelBufferBinding *binding,
                                       size_t default_bind_bytes) {
    uint64_t want = binding && binding->size ? binding->size : (uint64_t)default_bind_bytes;
    uint64_t min_bytes = parse_env_u64_default("SIFIVE_JOBD_KERNEL_BINDING_MIN_BYTES",
                                               parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_BINDING_MIN_BYTES", 0));
...
static float mmvf_load_value(enum SifiveMmvfXType type, const void *base, int64_t index) {
    if (type == SIFIVE_MMVF_F16) {
        return sifive_f16_to_f32(((const uint16_t *)base)[index]);
    } else if (type == SIFIVE_MMVF_BF16) {
        return sifive_bf16_to_f32(((const uint16_t *)base)[index]);
    }
    return ((const float *)base)[index];
}

static float mmvf_load_x(const struct MmvfNativeCtx *ctx, const void *base, int64_t index) {
    if (ctx && ctx->x_type == SIFIVE_MMVF_Q8_0) {
        ...
        return sifive_f16_to_f32(scale_bits) * (float)((const int8_t *)(qblock + 2))[lane];
    }
    return mmvf_load_value(ctx->x_type, base, index);
}

#if defined(__riscv_vector) && (defined(__riscv_zfh) || defined(__riscv_zfhmin))
static float sifive_dot_f16_f32_rvv(const uint16_t *x, const float *y, int32_t n) {
    if (n <= 0) return 0.0f;
    ...
    for (size_t i = 0; i < remaining; i++) {
        sum += sifive_f16_to_f32(xp[i]) * yp[i];
    }
    return sum;
}
#endif
...
static bool mmvf_xsfmm_bf16_rows4(const struct MmvfNativeCtx *ctx,
                                  ...
                                  uint32_t row_base) {
#if defined(HETGPU_SIFIVE_HAVE_XSFMM_BF16)
    if (!ctx || ctx->x_type != SIFIVE_MMVF_BF16 ||
        ctx->y_type != SIFIVE_MMVF_BF16 ||
    ...
    float out3 = ctile[12];
    for (; kk < total; kk++) {
        float y = sifive_bf16_to_f32(yh[kk]);
        out0 += sifive_bf16_to_f32(xh[(int64_t)0 * ctx->stride_row + kk]) * y;
        out1 += sifive_bf16_to_f32(xh[(int64_t)1 * ctx->stride_row + kk]) * y;
        out2 += sifive_bf16_to_f32(xh[(int64_t)2 * ctx->stride_row + kk]) * y;
        out3 += sifive_bf16_to_f32(xh[(int64_t)3 * ctx->stride_row + kk]) * y;
    }
    ...
    for (; kk + 3 < total; kk += 4) {
        for (uint32_t r = 0; r < 4; r++) {
            ...
            for (uint32_t k = 0; k < 4; k++) {
                ...
                uint16_t scale_bits;
                memcpy(&scale_bits, qblock, sizeof(scale_bits));
                float x = sifive_f16_to_f32(scale_bits) *
...
static void *mmvf_native_worker_main(void *opaque) {
    ...
    for (uint64_t idx = worker->begin; idx < worker->end; idx++) {
        ...
        if (ctx->x_type == SIFIVE_MMVF_BF16 && ctx->y_type == SIFIVE_MMVF_BF16 &&
            ctx->ncols_dst == 1) {
...
#endif
        } else if (ctx->x_type == SIFIVE_MMVF_Q8_0 && ctx->y_type == SIFIVE_MMVF_BF16 &&
                   ctx->ncols_dst == 1) {
            uint32_t row_group = row & ~3u;
            uint64_t group_idx = idx - (uint64_t)(row - row_group);
            bool group_in_worker = row_group + 3u < ctx->grid_x &&
        ...
        if (ctx->x_type == SIFIVE_MMVF_F16 && ctx->y_type == SIFIVE_MMVF_F32 &&
            ctx->ncols_dst == 1) {
            const uint16_t *xh = (const uint16_t *)x_base;
            const float *yf = (const float *)y_base;
            int32_t total = ctx->ncols2 * 2;
#if defined(__riscv_vector) && (defined(__riscv_zfh) || defined(__riscv_zfhmin))
            dst_base[row] = sifive_dot_f16_f32_rvv(xh, yf, total);
            continue;
#else
            int32_t i = 0;
            float s0 = 0.0f, s1 = 0.0f, s2 = 0.0f, s3 = 0.0f;
            for (; i + 7 < total; i += 8) {
                s0 += sifive_f16_to_f32(xh[i + 0]) * yf[i + 0];
                s1 += sifive_f16_to_f32(xh[i + 1]) * yf[i + 1];
                s2 += sifive_f16_to_f32(xh[i + 2]) * yf[i + 2];
                s3 += sifive_f16_to_f32(xh[i + 3]) * yf[i + 3];
                s0 += sifive_f16_to_f32(xh[i + 4]) * yf[i + 4];
                s1 += sifive_f16_to_f32(xh[i + 5]) * yf[i + 5];
                s2 += sifive_f16_to_f32(xh[i + 6]) * yf[i + 6];
                s3 += sifive_f16_to_f32(xh[i + 7]) * yf[i + 7];
            }
            float sum = (s0 + s1) + (s2 + s3);
            for (; i < total; i++) {
                sum += sifive_f16_to_f32(xh[i]) * yf[i];
            }
            dst_base[row] = sum;
            continue;
#endif
...
static int invoke_kernel_mmvf_native(const char *symbol,
    ...
    ctx.y_type = SIFIVE_MMVF_F32;
    if (ctx.x_type == SIFIVE_MMVF_UNSUPPORTED) return 1;
    ...
    if (ctx.x_type == SIFIVE_MMVF_F16) {
        sifive_prepare_f16_table();
    }
    ...
    ctx.grid_x = sifive_nonzero_dim(job->header.grid_x);
    ctx.grid_y = sifive_nonzero_dim(job->header.grid_y);
    ctx.grid_z = sifive_nonzero_dim(job->header.grid_z);

    if (ctx.ncols2 <= 0) return 0;
    void *local_x = NULL;
    void *local_y = NULL;
    uint64_t local_x_max = parse_env_u64_default("SIFIVE_JOBD_MMVF_LOCAL_X_MAX_BYTES", 0);
    uint64_t local_y_max = parse_env_u64_default("SIFIVE_JOBD_MMVF_LOCAL_Y_MAX_BYTES", 0);
    if ((ctx.x_type == SIFIVE_MMVF_F16 || ctx.x_type == SIFIVE_MMVF_F32) &&
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct MmvfNativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
...
static int run_mmvf_ctx(struct MmvfNativeCtx *ctx,
    ...
    if (ctx->x_type != SIFIVE_MMVF_F32 && ctx->x_type != SIFIVE_MMVF_F16 &&
        ctx->x_type != SIFIVE_MMVF_BF16 && ctx->x_type != SIFIVE_MMVF_Q8_0) {
        return 0xffff5003;
    }
    if (ctx->y_type != SIFIVE_MMVF_F32 && ctx->y_type != SIFIVE_MMVF_F16 &&
        ctx->y_type != SIFIVE_MMVF_BF16) {
        return 0xffff5003;
    }
    if (ctx->x_type == SIFIVE_MMVF_F16 || ctx->x_type == SIFIVE_MMVF_Q8_0 ||
        ctx->y_type == SIFIVE_MMVF_F16) {
        sifive_prepare_f16_table();
    }
    ...
    uint64_t work_items = (uint64_t)sifive_nonzero_dim(ctx->grid_x) *
                          sifive_nonzero_dim(ctx->grid_y) *
                          sifive_nonzero_dim(ctx->grid_z);
    unsigned workers = jobd_mmvf_worker_threads(work_items);
...
static int run_mmvf(int fd, const struct MmvfJob *job, uint64_t seq) {
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_MMVF, seq, 0x5140);
    ...
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_MMVF, seq, 0x5141);
    ...
    if (!compute) {
        mirror_progress_status(fd, HETGPU_SIFIVE_JOB_MMVF, seq, 0x5144);
        unmap_phys(&md);
        return 0;
    }
    ...
    ctx.x_type = (enum SifiveMmvfXType)job->x_type;
    ctx.y_type = mmvf_type_from_job_field(job->reserved0);

    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_MMVF, seq, 0x5142);
    int status = run_mmvf_ctx(&ctx, job->x_bytes, job->y_bytes, "MMVF");
    mirror_progress_status(fd, HETGPU_SIFIVE_JOB_MMVF, seq, status == 0 ? 0x5143 : (uint32_t)status);
    if (status == 0) {
        if (flush_map_to_phys(&md) != 0) {
            status = 0xffff5006;
            mirror_progress_status(fd, HETGPU_SIFIVE_JOB_MMVF, seq, (uint32_t)status);
        }
    }
...
enum SifiveRopeScalarType {
    SIFIVE_ROPE_SCALAR_UNSUPPORTED = 0,
    SIFIVE_ROPE_SCALAR_F32,
    SIFIVE_ROPE_SCALAR_F16,
};
...
struct RopeNormNativeCtx {
    ...
    bool has_ff;
    bool is_imrope;
    enum SifiveRopeScalarType x_type;
    enum SifiveRopeScalarType dst_type;
};
...
static uint16_t sifive_f32_to_f16(float f) {
    uint32_t x;
    memcpy(&x, &f, sizeof(x));
...
enum SifiveConvertScalarType {
    SIFIVE_CONVERT_SCALAR_UNSUPPORTED = 0,
    SIFIVE_CONVERT_SCALAR_F16,
    SIFIVE_CONVERT_SCALAR_F32,
};
...
struct ConvertUnaryNativeCtx {
    ...
    int64_t s02;
    int64_t s03;
    enum SifiveConvertScalarType src_type;
    enum SifiveConvertScalarType dst_type;
};
...
enum SifiveGetRowsScalarType {
    SIFIVE_GET_ROWS_SCALAR_UNSUPPORTED = 0,
    SIFIVE_GET_ROWS_SCALAR_F16,
    SIFIVE_GET_ROWS_SCALAR_F32,
    SIFIVE_GET_ROWS_SCALAR_I32,
    SIFIVE_GET_ROWS_SCALAR_BF16,
};
...
struct GetRowsFloatNativeCtx {
    ...
    int64_t s11;
    int64_t s12;
    enum SifiveGetRowsScalarType src_type;
    enum SifiveGetRowsScalarType dst_type;
};
...
static size_t get_rows_scalar_size(enum SifiveGetRowsScalarType ty) {
    switch (ty) {
    case SIFIVE_GET_ROWS_SCALAR_F16:
    case SIFIVE_GET_ROWS_SCALAR_BF16:
        return sizeof(uint16_t);
    case SIFIVE_GET_ROWS_SCALAR_F32:
        return sizeof(float);
    case SIFIVE_GET_ROWS_SCALAR_I32:
        return sizeof(int32_t);
    default:
        return 0;
    }
...
static bool get_rows_parse_scalar(const char **p,
                                  enum SifiveGetRowsScalarType *out) {
    if (!p || !*p || !out) return false;
    if (strncmp(*p, "6__half", 7) == 0) {
        *out = SIFIVE_GET_ROWS_SCALAR_F16;
        *p += 7;
        return true;
    }
    if (strncmp(*p, "13__nv_bfloat16", 15) == 0) {
        *out = SIFIVE_GET_ROWS_SCALAR_BF16;
        *p += 15;
        return true;
    }
    if (**p == 'f') {
        *out = SIFIVE_GET_ROWS_SCALAR_F32;
        *p += 1;
        return true;
    }
    if (**p == 'i') {
        *out = SIFIVE_GET_ROWS_SCALAR_I32;
        *p += 1;
        return true;
    }
    return false;
...
static float get_rows_load_scalar(const void *base,
                                  uint64_t index,
                                  enum SifiveGetRowsScalarType ty) {
    switch (ty) {
    case SIFIVE_GET_ROWS_SCALAR_F16:
        return sifive_f16_to_f32(((const uint16_t *)base)[index]);
    case SIFIVE_GET_ROWS_SCALAR_F32:
...
static void get_rows_store_scalar(void *base,
    ...
    switch (ty) {
    case SIFIVE_GET_ROWS_SCALAR_F16:
        ((uint16_t *)base)[index] = sifive_f32_to_f16(value);
        break;
    case SIFIVE_GET_ROWS_SCALAR_F32:
...
static void get_rows_copy_row(const struct GetRowsFloatNativeCtx *ctx,
                              const void *src_row,
                              void *dst_row) {
    if (ctx->src_type == SIFIVE_GET_ROWS_SCALAR_F32 &&
        ctx->dst_type == SIFIVE_GET_ROWS_SCALAR_F32) {
#if defined(__riscv_vector)
        uint64_t i = 0;
...
static int invoke_kernel_get_rows_float_native(const char *symbol,
    ...
    if (!env_flag_default_true("HETGPU_SIFIVE_ENABLE_NATIVE_GET_ROWS_FLOAT")) return 1;
    if (!job || argc < 15) return -1;

    struct GetRowsFloatNativeCtx ctx;
    memset(&ctx, 0, sizeof(ctx));
    if (!get_rows_float_parse_template(symbol, &ctx.src_type, &ctx.dst_type) ||
        ctx.src_type == SIFIVE_GET_ROWS_SCALAR_UNSUPPORTED ||
        ctx.dst_type == SIFIVE_GET_ROWS_SCALAR_UNSUPPORTED) {
        return 1;
    }
    ...
    ctx.ne10 = (int64_t)sifive_nonzero_dim(job->header.grid_x);
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct GetRowsFloatNativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
    uint64_t chunk = (rows + workers - 1u) / workers;
    memset(worker, 0, sizeof(worker));
    for (unsigned i = 0; i < workers; i++) {
...
static int invoke_kernel_scale_f32_native(const char *symbol,
    ...
    if (!env_flag_default_true("HETGPU_SIFIVE_ENABLE_NATIVE_SCALE_F32")) return 1;
    if (argc < 5) return -1;
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct ScaleF32NativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
...
static int invoke_kernel_cpy_scalar_f32_native(const char *symbol,
    ...
    if (!env_flag_default_true("HETGPU_SIFIVE_ENABLE_NATIVE_CPY_SCALAR")) return 1;
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct CpyScalarF32NativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
...
static bool convert_unary_parse_scalar(const char **p,
                                       enum SifiveConvertScalarType *out) {
    if (!p || !*p || !out) return false;
    if (strncmp(*p, "6__half", 7) == 0) {
        *out = SIFIVE_CONVERT_SCALAR_F16;
        *p += 7;
        return true;
    }
    if (**p == 'f') {
        *out = SIFIVE_CONVERT_SCALAR_F32;
        *p += 1;
        return true;
    }
    return false;
...
static float convert_unary_load_scalar(const void *base,
                                       uint64_t index,
                                       enum SifiveConvertScalarType ty) {
    switch (ty) {
    case SIFIVE_CONVERT_SCALAR_F16:
        return sifive_f16_to_f32(((const uint16_t *)base)[index]);
    case SIFIVE_CONVERT_SCALAR_F32:
        return ((const float *)base)[index];
    default:
        return 0.0f;
    }
...
static int invoke_kernel_convert_unary_native(const char *symbol,
    ...
    if (!env_flag_default_true("HETGPU_SIFIVE_ENABLE_NATIVE_CONVERT_UNARY")) return 1;
    if (argc < 9) return -1;

    struct ConvertUnaryNativeCtx ctx;
    memset(&ctx, 0, sizeof(ctx));
    if (!convert_unary_parse_types(symbol, &ctx.src_type, &ctx.dst_type) ||
        ctx.src_type == SIFIVE_CONVERT_SCALAR_UNSUPPORTED ||
        ctx.dst_type == SIFIVE_CONVERT_SCALAR_UNSUPPORTED) {
        return 1;
    }
    ...
    struct SifiveUint3 block_nums = kernel_cell_u3(args, argc, 5);
    ...
    unsigned workers = kernel_worker_threads(total);
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct ConvertUnaryNativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
    uint64_t chunk = (total + workers - 1u) / workers;
...
static float rope_native_load(const struct RopeNormNativeCtx *ctx, const void *base, int64_t index) {
    if (ctx->x_type == SIFIVE_ROPE_SCALAR_F16) {
        return sifive_f16_to_f32(((const uint16_t *)base)[index]);
    }
    return ((const float *)base)[index];
}
...
static void rope_native_store_pair(const struct RopeNormNativeCtx *ctx,
    ...
    if (ctx->dst_type == SIFIVE_ROPE_SCALAR_F16) {
        uint16_t *dst = (uint16_t *)ctx->dst;
        dst[index + 0] = sifive_f32_to_f16(x0);
        dst[index + 1] = sifive_f32_to_f16(x1);
    } else {
...
static void rope_native_store_one(const struct RopeNormNativeCtx *ctx,
    ...
    if (ctx->dst_type == SIFIVE_ROPE_SCALAR_F16) {
        ((uint16_t *)ctx->dst)[index] = sifive_f32_to_f16(value);
    } else {
...
static bool rope_norm_parse_template(const char *symbol,
                                     bool *forward_out,
                                     bool *has_ff_out,
                                     enum SifiveRopeScalarType *x_type_out,
                                     enum SifiveRopeScalarType *dst_type_out) {
    ...
    enum SifiveRopeScalarType x_type = SIFIVE_ROPE_SCALAR_UNSUPPORTED;
    enum SifiveRopeScalarType dst_type = SIFIVE_ROPE_SCALAR_UNSUPPORTED;
    if (types[0] == 'f') {
        x_type = SIFIVE_ROPE_SCALAR_F32;
        types += 1;
    } else if (strncmp(types, "6__half", 7) == 0) {
        x_type = SIFIVE_ROPE_SCALAR_F16;
        types += 7;
    } else {
        return false;
    }
    ...
    if (types[0] == 'f') {
        dst_type = SIFIVE_ROPE_SCALAR_F32;
    } else if (strncmp(types, "6__half", 7) == 0 || strncmp(types, "S0_", 3) == 0) {
        dst_type = SIFIVE_ROPE_SCALAR_F16;
    } else {
        return false;
    }
...
static bool rope_multi_parse_template(const char *symbol,
                                      bool *forward_out,
                                      bool *has_ff_out,
                                      enum SifiveRopeScalarType *type_out) {
    ...
    enum SifiveRopeScalarType type = SIFIVE_ROPE_SCALAR_UNSUPPORTED;
    if (types[0] == 'f') {
        type = SIFIVE_ROPE_SCALAR_F32;
    } else if (strncmp(types, "6__half", 7) == 0) {
        type = SIFIVE_ROPE_SCALAR_F16;
    } else {
        return false;
    }
...
static int invoke_kernel_rope_norm_native(const char *symbol,
    ...
    ctx.row_count = sifive_nonzero_dim(job->header.grid_x) *
                    sifive_nonzero_dim(job->header.block_x);
    ctx.pair_count = sifive_nonzero_dim(job->header.grid_y) *
                     sifive_nonzero_dim(job->header.block_y);
    ...
    uint64_t x_elem_bytes = ctx.x_type == SIFIVE_ROPE_SCALAR_F16 ? 2u : 4u;
    uint64_t dst_elem_bytes = ctx.dst_type == SIFIVE_ROPE_SCALAR_F16 ? 2u : 4u;
    ...
    uint64_t local_max = parse_env_u64_default("SIFIVE_JOBD_ROPE_LOCAL_MAX_BYTES",
                                               1u << 20);
    if (local_max != 0) {
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct RopeNormNativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
    uint64_t chunk = (work_items + workers - 1u) / workers;
    memset(worker, 0, sizeof(worker));
    for (unsigned i = 0; i < workers; i++) {
...
static int invoke_kernel_rope_multi_native(const char *symbol,
    ...
    uint64_t pos_bytes = kernel_binding_size_for_arg(job, 12);
    uint64_t freq_bytes = kernel_binding_size_for_arg(job, 18);
    uint64_t elem_bytes = ctx.x_type == SIFIVE_ROPE_SCALAR_F16 ? 2u : 4u;
...
enum SifiveSetRowsDstType {
    SIFIVE_SET_ROWS_DST_UNSUPPORTED = 0,
    SIFIVE_SET_ROWS_DST_F32,
    SIFIVE_SET_ROWS_DST_F16,
    SIFIVE_SET_ROWS_DST_BF16,
};
...
struct SetRowsNativeCtx {
    ...
    int64_t s3;
    bool idx_i64;
    enum SifiveSetRowsDstType dst_type;
};
...
static uint32_t set_rows_fastdiv_dim(struct SifiveUint3 v) {
    return v.z;
}

static bool set_rows_parse_template(const char *symbol,
                                    bool *idx_i64_out,
                                    enum SifiveSetRowsDstType *dst_type_out) {
    ...
    const char *dst = p + 3;
    if (dst[0] == 'f') {
        *dst_type_out = SIFIVE_SET_ROWS_DST_F32;
    } else if (strncmp(dst, "6__half", 7) == 0) {
        *dst_type_out = SIFIVE_SET_ROWS_DST_F16;
    } else if (strstr(dst, "bfloat16")) {
        *dst_type_out = SIFIVE_SET_ROWS_DST_BF16;
    } else {
        return false;
    }
    return true;
...
static void set_rows_store(const struct SetRowsNativeCtx *ctx, int64_t offset, float value) {
    switch (ctx->dst_type) {
    case SIFIVE_SET_ROWS_DST_F32:
        ((float *)ctx->dst)[offset] = value;
        break;
    case SIFIVE_SET_ROWS_DST_F16:
        ((uint16_t *)ctx->dst)[offset] = sifive_f32_to_f16(value);
        break;
    case SIFIVE_SET_ROWS_DST_BF16:
...
static int invoke_kernel_set_rows_native(const char *symbol,
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct SetRowsNativeWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
    uint64_t chunk = (work_items + workers - 1u) / workers;
    memset(worker, 0, sizeof(worker));
    for (unsigned i = 0; i < workers; i++) {
...
static int invoke_kernel_deepep_layout_native(const char *symbol,
    ...
    if (num_ranks == 1 && env_flag_default_true("HETGPU_SIFIVE_DEEPEP_LAYOUT_FAST_RANK1")) {
...
static int32_t kernel_arg_record_i32_for_arg(const struct SifiveJobImage *job, uint32_t arg_index) {
...
static void deepep_direct_marker(uint64_t seq, uint32_t status, uint32_t aux) {
    if (seq) {
        mirror_host_status(g_mbox_fd, SIFIVE_KERNEL_JOB_ID, seq, status);
        write_jobd_beacon(g_mbox_fd, SIFIVE_KERNEL_JOB_ID, seq, status, aux);
    }
}
    ...
    #define INDEX_EMBED_BEACON(phase_, detail_) \
        do { \
            if (g_mbox_fd >= 0 && g_current_kernel_seq) { \
                write_jobd_beacon(g_mbox_fd, SIFIVE_KERNEL_JOB_ID, g_current_kernel_seq, \
                                  (uint32_t)(phase_), (uint32_t)(detail_)); \
            } \
        } while (0)

    if (!symbol || (!strstr(symbol, "indexSelectSmallIndex") &&
                    !strstr(symbol, "sifive_pytorch_index_select_embedding"))) {
        return 1;
    }
...
static bool kernel_arg_record_u64(const struct SifiveJobImage *job,
                                  size_t index,
                                  uint64_t *out) {
    if (!job || !job->arg_records || index >= job->arg_count || !out) {
        return false;
    }
    const struct SifiveKernelArgRecord *rec = &job->arg_records[index];
    if ((rec->flags & SIFIVE_KERNEL_ARG_FLAG_INLINE_BLOB) && rec->size > sizeof(uint64_t)) {
        return false;
    }
...
copy_packed_embedding:
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, seq,
...
static int invoke_kernel_bin_bcast_elf_rows(const char *symbol,
    ...
    struct SifiveUint3 ne3 = kernel_cell_u3(args, argc, 6);
    ...
    pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
    struct BinBcastElfRowWorker worker[SIFIVE_KERNEL_MAX_THREADS];
    unsigned created = 0;
...
static int invoke_kernel_symbol_grid(const char *symbol, void *fn,
                                     ...
                                     size_t argc,
                                     SifiveSetLaunchFn set_launch) {
    uint32_t gx = sifive_nonzero_dim(job ? job->header.grid_x : 1u);
    uint32_t gy = sifive_nonzero_dim(job ? job->header.grid_y : 1u);
    uint32_t gz = sifive_nonzero_dim(job ? job->header.grid_z : 1u);
    uint32_t bx = sifive_nonzero_dim(job ? job->header.block_x : 1u);
    uint32_t by = sifive_nonzero_dim(job ? job->header.block_y : 1u);
    uint32_t bz = sifive_nonzero_dim(job ? job->header.block_z : 1u);
    ...
    if (workers > 1) {
        pthread_t threads[SIFIVE_KERNEL_MAX_THREADS];
        struct KernelGridWorker worker[SIFIVE_KERNEL_MAX_THREADS];
        unsigned created = 0;
...
static void release_kernel_binding_maps(struct KernelBindingMap *maps, size_t count) {
    for (size_t i = 0; i < count; i++) {
        bool needs_copyback = (maps[i].flags & SIFIVE_KERNEL_ARG_FLAG_BUFFER_OUTPUT) != 0;
        if (needs_copyback) {
            ...
            if (!maps[i].map.copied && maps[i].map.ptr && maps[i].map.len) {
                /*
                 * Some shared-DDR mappings are visible to the SIFIVE Linux process
...
static void release_kernel_binding_maps_native_fast(struct KernelBindingMap *maps,
    ...
    for (size_t i = 0; i < count; i++) {
        bool needs_copyback =
            copyback_outputs &&
            ((maps[i].flags & SIFIVE_KERNEL_ARG_FLAG_BUFFER_OUTPUT) != 0);
        if (needs_copyback) {
            if (flush_map_to_phys(&maps[i].map) != 0) {
...
static int build_kernel_launch_args(
    ...
    uint64_t *argv_out,
    size_t *argc_out,
    struct KernelParamCell arg_storage[SIFIVE_MAX_KERNEL_ARGS],
    ...
    if (job->arg_count > SIFIVE_MAX_KERNEL_ARGS || job->binding_count > SIFIVE_MAX_KERNEL_BINDINGS) {
        log_msg("kernel launch ABI too large: args=%zu/%u bindings=%zu/%u",
                job->arg_count, SIFIVE_MAX_KERNEL_ARGS,
                job->binding_count, SIFIVE_MAX_KERNEL_BINDINGS);
        g_kernel_arg_error = 0xe2;
        return -1;
    }

    for (size_t i = 0; i < job->binding_count; i++) {
        const struct SifiveKernelBufferBinding *binding = &job->bindings[i];
        size_t bind_bytes = kernel_binding_map_bytes(binding, default_bind_bytes);
        if (map_count >= SIFIVE_MAX_KERNEL_BINDINGS) {
            log_msg("kernel binding map limit reached: bindings=%zu map_count=%zu max=%u",
                    job->binding_count, map_count, SIFIVE_MAX_KERNEL_BINDINGS);
    ...
    if (job->arg_count) {
        for (size_t i = 0; i < job->arg_count; i++) {
            const struct SifiveKernelArgRecord *rec = &job->arg_records[i];
            uint64_t value = rec->value;
            if ((rec->flags & SIFIVE_KERNEL_ARG_FLAG_INLINE_BLOB) && rec->size > 16U) {
        ...
        if (words > SIFIVE_MAX_KERNEL_ARGS) {
            release_kernel_binding_maps(maps, map_count);
...
static void trace_kernel_param_cells(const char *symbol,
    ...
    for (size_t i = 0; i < argc; i++) {
        ...
        if (cells && argv && argv[i] >= (uint64_t)(uintptr_t)&cells[0] &&
            argv[i] < (uint64_t)(uintptr_t)&cells[SIFIVE_MAX_KERNEL_ARGS]) {
...
static int parse_kernel_job_image_with_total(const uint8_t *image,
                                             size_t image_len,
                                             size_t total_len,
                                             struct SifiveJobImage *out) {
    size_t abi_len = SIFIVE_KERNEL_LAUNCH_ABI_WIRE_BYTES;
    g_kernel_parse_error = 0;
    if (total_len < image_len) {
        total_len = image_len;
    }

    if (!image || !out || image_len < SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES) {
        log_msg("kernel image parse failed: image=%p out=%p len=%zu header=%zu",
                (const void *)image, (void *)out, image_len, (size_t)SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES);
     ...
     * SIFIVE-side jobd. Decode it explicitly so compiler-specific struct padding
    ...
    if (out->header.magic != SIFIVE_JOB_MAGIC || out->header.version != SIFIVE_JOB_VERSION) {
    ...
    if (out->header.flags & SIFIVE_JOB_FLAG_HAS_LAUNCH_ABI) {
        if (image_len < SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES + abi_len) {
            log_msg("kernel image parse failed: ABI header truncated len=%zu need=%zu",
                    image_len, (size_t)SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES + abi_len);
            g_kernel_parse_error = 0x04;
            return -1;
        }
        const uint8_t *abi = image + SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES;
        ...
        if (out->abi->magic != SIFIVE_KERNEL_LAUNCH_ABI_MAGIC ||
            out->abi->version != SIFIVE_KERNEL_LAUNCH_ABI_VERSION) {
        ...
        if (out->abi->arg_record_count) {
            size_t bytes = (size_t)out->abi->arg_record_count * SIFIVE_KERNEL_ARG_RECORD_WIRE_BYTES;
            if (out->abi->arg_record_count > SIFIVE_MAX_KERNEL_ARGS) {
                log_msg("kernel image parse failed: too many arg records count=%u max=%u",
                        out->abi->arg_record_count, SIFIVE_MAX_KERNEL_ARGS);
            ...
            for (uint32_t i = 0; i < out->abi->arg_record_count; i++) {
                const uint8_t *rec = image + out->abi->arg_records_offset +
                                     (size_t)i * SIFIVE_KERNEL_ARG_RECORD_WIRE_BYTES;
        ...
        if (out->abi->binding_count) {
            size_t bytes = (size_t)out->abi->binding_count * SIFIVE_KERNEL_BUFFER_BINDING_WIRE_BYTES;
            if (out->abi->binding_count > SIFIVE_MAX_KERNEL_BINDINGS) {
                log_msg("kernel image parse failed: too many bindings count=%u max=%u",
                        out->abi->binding_count, SIFIVE_MAX_KERNEL_BINDINGS);
            ...
            for (uint32_t i = 0; i < out->abi->binding_count; i++) {
                const uint8_t *binding = image + out->abi->bindings_offset +
                                         (size_t)i * SIFIVE_KERNEL_BUFFER_BINDING_WIRE_BYTES;
...
static int parse_kernel_job_image(const uint8_t *image, size_t image_len, struct SifiveJobImage *out) {
...
static int load_kernel_job_image_view(int fd,
                                      const struct SifiveJobDesc *desc,
                                      struct Map *map,
                                      uint8_t **image_copy,
                                      const uint8_t **image) {
...
static bool kernel_metadata_prefix_len_from_head(const uint8_t *head,
    ...
    uint64_t image_size;
    size_t entry_offset;
    size_t need = SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES + SIFIVE_KERNEL_LAUNCH_ABI_WIRE_BYTES;
    const uint8_t *abi;
    uint64_t abi_magic;
    ...
    if (magic != SIFIVE_JOB_MAGIC || version != SIFIVE_JOB_VERSION ||
    ...
    abi = head + SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES;
    abi_magic = read_u64_le(abi + 0);
    abi_version = read_u32_le(abi + 8);
    if (abi_magic != SIFIVE_KERNEL_LAUNCH_ABI_MAGIC ||
        abi_version != SIFIVE_KERNEL_LAUNCH_ABI_VERSION) {
        return false;
    }
    ...
    if (arg_count > SIFIVE_MAX_KERNEL_ARGS ||
        binding_count > SIFIVE_MAX_KERNEL_BINDINGS) {
        return false;
    }
    if (!kernel_metadata_section_need(&need, entry_offset, arg_off, arg_count,
                                      SIFIVE_KERNEL_ARG_RECORD_WIRE_BYTES) ||
        !kernel_metadata_section_need(&need, entry_offset, binding_off, binding_count,
                                      SIFIVE_KERNEL_BUFFER_BINDING_WIRE_BYTES) ||
...
static int load_kernel_job_metadata_view(int fd,
    ...
    if (!desc || !image_copy || !image || !image_len ||
        desc->len < SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES + SIFIVE_KERNEL_LAUNCH_ABI_WIRE_BYTES ||
...
static int dispatch_kernel_job_metadata_fast(int fd, const struct SifiveJobDesc *desc) {
    struct SifiveJobImage job;
    ...
    if (!desc || desc->buf_info != SIFIVE_JOB_MAGIC ||
        desc->len < SIFIVE_JOB_IMAGE_HEADER_WIRE_BYTES + SIFIVE_KERNEL_LAUNCH_ABI_WIRE_BYTES) {
        return 1;
    }
    ...
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x510e,
    ...
    if (symbol[0] && jobd_generic_noop_enabled()) {
        trace_msg("generic kernel noop metadata-fast: seq=%" PRIu64 " symbol=%s",
                  desc->seq, symbol);
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x510f, 0);
        free(image_copy);
        return 0;
    }
    ...
    if (symbol[0]) {
        ...
        if (direct_native_status <= 0) {
            ...
            uint32_t error_status = (native_u & 0xffff0000u) == 0xffff0000u
                ? native_u
                : 0xffff5d00u;
            write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq,
    ...
    if (symbol[0] && (strstr(symbol, "scale_f32") ||
        ...
        uint64_t argv[SIFIVE_MAX_KERNEL_ARGS];
        struct KernelParamCell arg_storage[SIFIVE_MAX_KERNEL_ARGS];
        struct KernelBindingMap binding_maps[SIFIVE_MAX_KERNEL_BINDINGS];
        size_t argc = 0;
...
static int dispatch_kernel_job(int fd, const struct SifiveJobDesc *desc) {
    struct Map map = {0};
    struct SifiveJobImage job;
    uint8_t *image_copy = NULL;
    const uint8_t *image = NULL;
    ...
    void *fn = NULL;
    SifiveSetLaunchFn set_launch = NULL;
    int status = 0;
    uint64_t parse_retries = parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_PARSE_RETRIES", 4096);
    uint64_t parse_retry_us = parse_env_u64_default("HETGPU_SIFIVE_JOBD_KERNEL_PARSE_RETRY_US", 1000);

    memset(binding_maps, 0, sizeof(binding_maps));
    memset(&loaded, 0, sizeof(loaded));
    if (!desc || desc->buf_info != SIFIVE_JOB_MAGIC || desc->len < sizeof(struct SifiveJobImageHeader)) {
        return 0xffff5001;
    }
    ...
    if (load_kernel_job_image_view(fd, desc, &map, &image_copy, &image) != 0) {
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5002u, errno ? (uint32_t)errno : 0);
        return 0xffff5002;
    }
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5102);
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5102, image_copy ? 1U : 0U);
    for (uint64_t parse_attempt = 0;; parse_attempt++) {
        ...
        if (!kernel_job_parse_retryable(detail) || parse_attempt >= parse_retries) {
            write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5300u | (detail ? detail : 0xffu), detail);
        ...
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x510a, detail);
        reset_kernel_job_image_view(&map, &image_copy);
        if (parse_retry_us) {
    ...
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5103);
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5103, (uint32_t)job.arg_count);
    ...
    if (build_kernel_launch_args(fd, &job, symbol, argv, &argc, arg_storage, binding_maps, &binding_map_count) != 0) {
        ...
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5200u | (detail ? detail : 0x05u), detail);
        free(image_copy);
        unmap_phys(&map);
        return 0xffff5200u | (detail ? detail : 0x05u);
    }
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5104);
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5104, (uint32_t)argc);
    ...
    if (symbol[0]) {
        ...
        if (native_status <= 0) {
            ...
            uint32_t error_status = (native_u & 0xffff0000u) == 0xffff0000u
                ? native_u
                : 0xffff5007u;
            write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, error_status, native_u);
            release_kernel_binding_maps_native_fast(binding_maps,
                                                    binding_map_count,
                                                    native_status == 0);
            free(image_copy);
    ...
    if (!jobd_elf_fallback_enabled()) {
        ...
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5010u, 0);
    ...
    if (load_kernel_image(job.elf, job.elf_len, job.header.kernel_name_hash,
        ...
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5000u | (detail ? detail : 0x004u), detail);
        release_kernel_binding_maps(binding_maps, binding_map_count);
        free(image_copy);
        unmap_phys(&map);
        return 0xffff5000u | (detail ? detail : 0x004u);
    }
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5105);
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5105, (uint32_t)(job.elf_len & 0xffffffffu));
    ...
    if (!fn) {
        ...
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5006u, 0);
        release_kernel_binding_maps(binding_maps, binding_map_count);
    ...
    set_launch = loaded.direct
                     ? loaded.set_launch
                     : (SifiveSetLaunchFn)dlsym(loaded.handle, "f___zluda_ptx_impl_set_launch");

    trace_msg("kernel dispatch: seq=%" PRIu64 " symbol=%s argc=%zu artifact=%s logical_threads=%" PRIu64,
              desc->seq, symbol, argc, artifact,
              (uint64_t)sifive_nonzero_dim(job.header.grid_x) *
              sifive_nonzero_dim(job.header.grid_y) *
              sifive_nonzero_dim(job.header.grid_z) *
              sifive_nonzero_dim(job.header.block_x) *
              sifive_nonzero_dim(job.header.block_y) *
              sifive_nonzero_dim(job.header.block_z));
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5106);
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5106, (uint32_t)argc);
    g_current_kernel_seq = desc->seq;
    g_current_kernel_symbol = symbol;
    status = invoke_kernel_symbol_grid(symbol, fn, argv, &job, argc, set_launch);
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5107);
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5107, (uint32_t)status);
    trace_msg("kernel dispatch returned: seq=%" PRIu64 " symbol=%s status=%d",
              desc->seq, symbol, status);
    g_current_kernel_symbol = NULL;
    g_current_kernel_seq = 0;

    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5108);
    release_kernel_binding_maps(binding_maps, binding_map_count);
    mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5109);
    unload_kernel_image(&loaded);
    free(image_copy);
    unmap_phys(&map);
    if (status != 0) {
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0xffff5007u, (uint32_t)status);
        return 0xffff5007;
    }
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc->seq, 0x5109, 0);
    return 0;
}
...
static void *arg_payload_inner(volatile struct Doorbell *ctl, uint32_t job_id, uint64_t seq, size_t want, bool noisy) {
    ...
    volatile struct ArgSlotHeader *h =
        (volatile struct ArgSlotHeader *)(base + HETGPU_SIFIVE_ARG_BASE_OFF +
                                          (size_t)slot * HETGPU_SIFIVE_ARG_SLOT_BYTES);
    __sync_synchronize();
    if (h->magic != HETGPU_SIFIVE_JOB_MAGIC || h->version != HETGPU_SIFIVE_JOB_VERSION ||
...
static SIFIVE_UNUSED void *arg_payload(volatile struct Doorbell *ctl, uint32_t job_id, uint64_t seq, size_t want) {
...
static int arg_payload_copy_inner(int fd, uint32_t job_id, uint64_t seq, size_t want, void *out, bool noisy) {
    ...
    if (slot < 0 || !out || want > HETGPU_SIFIVE_ARG_SLOT_BYTES - sizeof(header)) {
        return -1;
    }
    ...
    if (g_control_window) {
        ...
        if (header.magic == HETGPU_SIFIVE_JOB_MAGIC &&
            header.version == HETGPU_SIFIVE_JOB_VERSION &&
            (header.job_id == job_id || header.job_id == 0) &&
            header.seq == seq &&
            header.arg_len >= want) {
            slot_bytes = malloc(HETGPU_SIFIVE_ARG_SLOT_BYTES);
            if (slot_bytes) {
                memcpy(slot_bytes, mapped_slot, HETGPU_SIFIVE_ARG_SLOT_BYTES);
    ...
    for (size_t c = 0; !slot_bytes && c < 4; c++) {
        ...
        if (read_shared_ddr_control_copy_pread_candidate(fd, slot_off, HETGPU_SIFIVE_ARG_SLOT_BYTES, c, &candidate) != 0) {
            continue;
        }
    ...
    if (!slot_bytes &&
        read_phys_copy(fd,
                       shared_ddr_control_phys(slot_off, HETGPU_SIFIVE_ARG_SLOT_BYTES),
                       HETGPU_SIFIVE_ARG_SLOT_BYTES,
                       &slot_bytes) != 0) {
...
static bool refresh_runtime_table(int fd, volatile struct Doorbell *ctl, struct PreloadedJobs *jobs, uint64_t *last_table_seq) {
    ...
    if (g_control_window) {
        volatile struct RuntimeJobTable *table =
            (volatile struct RuntimeJobTable *)(g_control_window + HETGPU_SIFIVE_RUNTIME_TABLE_OFF);
        memcpy(&local, (const void *)table, sizeof(local));
        __sync_synchronize();
        have_copy =
            local.magic == HETGPU_SIFIVE_RUNTIME_TABLE_MAGIC &&
            local.version == HETGPU_SIFIVE_RUNTIME_TABLE_VERSION &&
            local.seq != 0 &&
    ...
    for (size_t c = 0; !have_copy && c < 4; c++) {
        uint8_t *candidate = NULL;
        if (read_shared_ddr_control_copy_pread_candidate(fd, HETGPU_SIFIVE_RUNTIME_TABLE_OFF,
                                                         sizeof(local), c, &candidate) != 0) {
            continue;
        }
        memcpy(&local, candidate, sizeof(local));
        free(candidate);
        if (local.magic == HETGPU_SIFIVE_RUNTIME_TABLE_MAGIC &&
            local.version == HETGPU_SIFIVE_RUNTIME_TABLE_VERSION &&
            local.seq != 0 &&
            local.seq != *last_table_seq) {
            have_copy = true;
    ...
    if (!have_copy &&
        read_phys_copy(fd,
                       shared_ddr_control_phys(HETGPU_SIFIVE_RUNTIME_TABLE_OFF, sizeof(local)),
                       sizeof(local),
                       &table_bytes) == 0) {
...
static int dispatch_job(int fd, volatile struct Doorbell *ctl, const struct PreloadedJobs *jobs, bool strict) {
    ...
    if (job_id == HETGPU_SIFIVE_JOB_SOFTMAX) {
    ...
    if (job_id == HETGPU_SIFIVE_JOB_RMSNORM) {
        ...
        if (rms_status == 0) {
            mirror_aligned_completion_record(fd, HETGPU_SIFIVE_JOB_RMSNORM, seq, 0);
            submit_mbox_payload_sync(g_mbox_fd,
                                     HETGPU_SIFIVE_JOB_RMSNORM,
                                     seq,
                                     0,
    ...
    if (job_id == HETGPU_SIFIVE_JOB_ALLREDUCE) {
    ...
    if (job_id == HETGPU_SIFIVE_JOB_MMVF) {
...
static bool host_completion_visible(int fd, uint32_t job_id, uint64_t seq, uint32_t status) {
    ...
    uint8_t *copy = NULL;
    uint64_t phys = shared_ddr_control_phys(HETGPU_SIFIVE_COMPLETION_OFF, sizeof(seen));
    bool ok = false;
    ...
    if (read_phys_copy(fd, phys, sizeof(seen), &copy) == 0 && copy) {
        ...
        free(copy);
        ok = seen.magic == HETGPU_SIFIVE_JOB_MAGIC &&
             seen.version == HETGPU_SIFIVE_JOB_VERSION &&
             seen.job_id == job_id &&
             seen.seq == seq &&
             seen.status == status;
    }
...
static bool kernel_completion_visible(int fd, uint64_t seq, uint32_t status) {
    return host_completion_visible(fd, SIFIVE_KERNEL_JOB_ID, seq, status);
}

static bool kernel_completion_seq_visible(int fd, uint64_t seq) {
    return host_completion_seq_visible(fd, SIFIVE_KERNEL_JOB_ID, seq);
}
...
static enum DispatchPollResult maybe_dispatch_kernel_job(
    ...
    const struct SifiveJobDesc *kernel_desc = (const struct SifiveJobDesc *)(const void *)ctl;
    struct SifiveJobDesc desc;
    int status;
    ...
    if (desc.buf_info != SIFIVE_JOB_MAGIC ||
        desc.len < sizeof(struct SifiveJobImageHeader)) {
    ...
    if (desc.seq == *last_kernel_seq) {
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, 0x510d, 0);
    }
    ...
    if (pending_completion_valid && pending_completion_seq == desc.seq) {
        ...
        trace_msg("new kernel doorbell: seq=%" PRIu64 " addr=0x%" PRIx64 " len=%" PRIu64,
                  desc.seq, desc.addr, desc.len);
        mirror_progress_status(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, 0x5101);
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, 0x5101, (uint32_t)(desc.len & 0xffffffffu));
        status = dispatch_kernel_job(fd, &desc);
        pending_completion_seq = desc.seq;
        pending_completion_status = (uint32_t)status;
        pending_completion_valid = true;
    }
    submit_mbox_payload_sync(g_mbox_fd, SIFIVE_KERNEL_JOB_ID, desc.seq,
                             (uint32_t)status, "kernel-before-completion");
    write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, (uint32_t)status, 0);
    mirror_host_status(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, (uint32_t)status);
    submit_mbox_payload_sync(g_mbox_fd, SIFIVE_KERNEL_JOB_ID, desc.seq,
    ...
    if (!jobd_require_completion_visible_enabled() ||
        ...
        if ((uint32_t)status == 0) {
            for (unsigned i = 0; i < 3; i++) {
                write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, 0x511b, 0);
                sleep_us(1000);
            }
        } else {
            write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, 0x511b, (uint32_t)status);
        }
    } else {
        write_jobd_beacon(fd, SIFIVE_KERNEL_JOB_ID, desc.seq, 0x511a, (uint32_t)status);
...
static enum DispatchPollResult maybe_dispatch_preloaded_job(
    ...
    if (ctl->magic != HETGPU_SIFIVE_JOB_MAGIC || ctl->version != HETGPU_SIFIVE_JOB_VERSION) {
        return DISPATCH_INVALID;
    }
    ...
    if (env_flag_true(getenv("HETGPU_SIFIVE_JOBD_COMPLETION_SYNC"))) {
...
static enum DispatchPollResult maybe_dispatch_gemm_arg_slot_direct(int fd,
                                                                   uint64_t *last_seq) {
    const uint32_t job_id = HETGPU_SIFIVE_JOB_GEMM;
    int slot = arg_slot_for_job(job_id);
    uint64_t slot_off;
    ...
    if (slot < 0 || !g_ddr_info.ddr_base || !g_ddr_info.ddr_size ||
        g_sifive_id >= HETGPU_SIFIVE_COUNT) {
        return DISPATCH_IDLE;
    }
    slot_off = (uint64_t)g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES +
               HETGPU_SIFIVE_ARG_BASE_OFF +
               (uint64_t)slot * HETGPU_SIFIVE_ARG_SLOT_BYTES;
    if (slot_off > g_ddr_info.ddr_size ||
        HETGPU_SIFIVE_ARG_SLOT_BYTES > g_ddr_info.ddr_size - slot_off ||
        sizeof(job) > HETGPU_SIFIVE_ARG_SLOT_BYTES) {
        return DISPATCH_IDLE;
    }
    ...
    if (!((header.magic == HETGPU_SIFIVE_JOB_MAGIC ||
           header.magic == HETGPU_SIFIVE_RUNTIME_TABLE_MAGIC) &&
          header.version == HETGPU_SIFIVE_JOB_VERSION &&
          header.seq != 0)) {
        return DISPATCH_IDLE;
    }
    ...
    payload_off = header.magic == HETGPU_SIFIVE_JOB_MAGIC ? 0x20ULL : 0x38ULL;
    if (payload_off > HETGPU_SIFIVE_ARG_SLOT_BYTES ||
        sizeof(job) > HETGPU_SIFIVE_ARG_SLOT_BYTES - payload_off) {
        return DISPATCH_IDLE;
    }
...
static enum DispatchPollResult maybe_dispatch_arg_slot_job(
    ...
    select_sifive_id_from_arg_slot_candidate(g_pending_arg_header_sifive_id,
                                           header.job_id,
                                           header.seq);
    ...
    ctl->magic = HETGPU_SIFIVE_JOB_MAGIC;
    ctl->version = HETGPU_SIFIVE_JOB_VERSION;
...
static void maybe_heartbeat_control(int fd,
    ...
    const struct SifiveJobDesc *kernel_head;
    ...
    kernel_head = (const struct SifiveJobDesc *)(const void *)snapshot;
    if (head->magic == HETGPU_SIFIVE_JOB_MAGIC &&
        head->version == HETGPU_SIFIVE_JOB_VERSION) {
        status = 0x7001;
        job_id = head->job_id;
        seq = head->seq;
    } else if (kernel_head->buf_info == SIFIVE_JOB_MAGIC) {
        status = kernel_head->seq == last_kernel_seq ? 0x7102 : 0x7202;
        job_id = SIFIVE_KERNEL_JOB_ID;
        seq = kernel_head->seq;
    } else {
        job_id = SIFIVE_KERNEL_JOB_ID;
        seq = kernel_head->seq;
...
static bool control_has_pending_job(int fd,
                                    uint64_t last_seq,
                                    uint64_t last_kernel_seq) {
    uint8_t header[sizeof(struct SifiveJobDesc)];
    ...
    kernel_head = (const struct SifiveJobDesc *)(const void *)header;
    if (head->magic == HETGPU_SIFIVE_JOB_MAGIC &&
        head->version == HETGPU_SIFIVE_JOB_VERSION &&
        head->seq != 0 &&
        head->seq != last_seq &&
    ...
    if (kernel_head->buf_info == SIFIVE_JOB_MAGIC &&
        kernel_head->seq != 0 &&
...
static uint32_t control_snapshot_detail(const uint8_t *snapshot,
    ...
    kernel_head = (const struct SifiveJobDesc *)(const void *)snapshot;
    snapshot_preloaded =
        head->magic == HETGPU_SIFIVE_JOB_MAGIC &&
        head->version == HETGPU_SIFIVE_JOB_VERSION &&
        head->seq != 0 &&
        head->seq != last_seq;
    snapshot_kernel =
        kernel_head->buf_info == SIFIVE_JOB_MAGIC &&
        kernel_head->seq != 0 &&
        kernel_head->seq != last_kernel_seq;
    if (seq_out) {
    ...
    detail = (snapshot_preloaded ? 0x0001u : 0u) |
             ...
             (head->magic == HETGPU_SIFIVE_JOB_MAGIC ? 0x0004u : 0u) |
             (head->version == HETGPU_SIFIVE_JOB_VERSION ? 0x0008u : 0u) |
             (head->seq != 0 ? 0x0010u : 0u) |
             (kernel_head->seq != 0 ? 0x0020u : 0u) |
             (kernel_head->buf_info == SIFIVE_JOB_MAGIC ? 0x0040u : 0u) |
...
static uint64_t post_irq_scan_us(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_POST_IRQ_SCAN_US", 2000000ULL);
}

static uint64_t post_irq_scan_sleep_us(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_POST_IRQ_SCAN_SLEEP_US", 50ULL);
}

static uint64_t pre_poll_scan_us(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_PRE_POLL_SCAN_US", 50000ULL);
}

static uint64_t pre_poll_scan_sleep_us(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_PRE_POLL_SCAN_SLEEP_US", 50ULL);
}
...
static uint32_t load_dispatch_snapshot(int fd,
    ...
    mirror_diag_progress_status(fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7020);
    memset(snapshot, 0, HETGPU_SIFIVE_CONTROL_BYTES);
    sync_map_for_cpu(control_map);
    mirror_diag_progress_status(fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7021);
    if (read_control_snapshot(fd, snapshot, sizeof(struct SifiveJobDesc)) != 0) {
        mirror_diag_progress_status(fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7022);
        sync_map_for_cpu(control_map);
    ...
    mirror_diag_progress_status(fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq,
                                0x70230000u | detail);
    if ((detail & 0x2u) != 0 ||
        (((detail & 0x1u) != 0) && jobd_full_control_snapshot_enabled())) {
        mirror_diag_progress_status(fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq,
                                    0x70240000u | detail);
        if (read_control_snapshot(fd, snapshot, HETGPU_SIFIVE_CONTROL_BYTES) == 0) {
            jobd_io_fence();
            if (dispatch_ctl) {
...
static uint64_t initial_scan_us(void) {
    return parse_env_u64_default("HETGPU_SIFIVE_JOBD_INITIAL_SCAN_US", 200000ULL);
}

static volatile struct Doorbell *scan_for_control(int fd, const struct sifive_zluda_ddr_info *ddr_info, struct Map *map) {
    uint64_t control_off = g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES;
    if (!ddr_info || !ddr_info->ddr_base ||
        control_off > ddr_info->ddr_size ||
        HETGPU_SIFIVE_CONTROL_BYTES > ddr_info->ddr_size - control_off) {
        log_msg("invalid shared ddr control window: sifive_id=%" PRIu64 " base=0x%" PRIx64 " size=0x%" PRIx64,
                g_sifive_id, ddr_info ? ddr_info->ddr_base : 0, ddr_info ? ddr_info->ddr_size : 0);
        return NULL;
    }
    if (map_phys(fd, ddr_info->ddr_base + control_off, HETGPU_SIFIVE_CONTROL_BYTES, map)) {
        log_msg("map shared DDR control sifive_id=%" PRIu64 " phys=0x%" PRIx64 " len 0x%x failed: %s",
                g_sifive_id, ddr_info->ddr_base + control_off,
                (unsigned)HETGPU_SIFIVE_CONTROL_BYTES, strerror(errno));
        return NULL;
    }
    trace_msg("mapped shared DDR control sifive_id=%" PRIu64 " at phys 0x%" PRIx64 " len 0x%x",
              g_sifive_id, ddr_info->ddr_base + control_off,
              (unsigned)HETGPU_SIFIVE_CONTROL_BYTES);
...
static void seed_last_seen_sequences(volatile struct Doorbell *ctl,
    ...
    } else if (kernel_desc->buf_info == SIFIVE_JOB_MAGIC) {
...
static bool mirror_host_status_mbox_dual_pwrite(const struct HostStatus *status_msg) {
    ...
    ddr_off = g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES + HETGPU_SIFIVE_COMPLETION_OFF;
    if (ddr_off > g_ddr_info.ddr_size ||
    ...
    offsets[1] = ddr_off;
    offsets[2] = HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF + ddr_off;
...
static bool mirror_host_status_payload_mirror(const struct HostStatus *status_msg) {
    ...
    mirror_off = parse_env_u64_default("HETGPU_SIFIVE_JOBD_COMPLETION_MIRROR_OFF",
                                       0);
    if (mirror_off == 0) {
        return false;
    }
    control_off = g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES + HETGPU_SIFIVE_COMPLETION_OFF;
    ...
    offsets[2] = HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF + mirror_off + control_off;
    jobd_io_fence();
    for (size_t i = 0; i < sizeof(offsets) / sizeof(offsets[0]); i++) {
        bool duplicate = false;
        for (size_t j = 0; j < i; j++) {
...
static bool mirror_host_status_control_window_direct(uint32_t job_id, uint64_t seq, uint32_t status) {
    if (!g_control_window ||
        HETGPU_SIFIVE_COMPLETION_OFF > HETGPU_SIFIVE_CONTROL_BYTES ||
        sizeof(struct HostStatus) > HETGPU_SIFIVE_CONTROL_BYTES - HETGPU_SIFIVE_COMPLETION_OFF) {
        return false;
    }

    volatile struct HostStatus *host =
        (volatile struct HostStatus *)(g_control_window + HETGPU_SIFIVE_COMPLETION_OFF);
    jobd_io_fence();
...
static void mirror_host_status(int fd, uint32_t job_id, uint64_t seq, uint32_t status) {
    struct Map map = {0};
    uint64_t phys = shared_ddr_control_phys(HETGPU_SIFIVE_COMPLETION_OFF, sizeof(struct HostStatus));
    ...
    if (env_flag_true(getenv("HETGPU_SIFIVE_JOBD_DEVMEM_DIRECT_STATUS")) &&
...
static bool write_shared_ddr_devmem_direct(uint64_t phys, const void *src, size_t len) {
    ...
    mmap_phys = shared_ddr_sifive_phys(host_phys, len);
...
static bool arg_slot_fast_peek_direct(uint32_t job_id) {
    ...
    return (header.magic == HETGPU_SIFIVE_JOB_MAGIC ||
            header.magic == HETGPU_SIFIVE_RUNTIME_TABLE_MAGIC) &&
           header.version == HETGPU_SIFIVE_JOB_VERSION &&
           header.seq != 0;
}
...
static bool mirror_boot_marker_all_slots_mbox_mmap(int fd, uint32_t status) {
    const size_t map_len = HETGPU_SIFIVE_COUNT * HETGPU_SIFIVE_CONTROL_BYTES;
    void *base;
    ...
    for (uint32_t slot = 0; slot < HETGPU_SIFIVE_COUNT; slot++) {
        ...
        host->magic = HETGPU_SIFIVE_JOB_MAGIC;
        host->version = HETGPU_SIFIVE_JOB_VERSION;
        host->job_id = SIFIVE_KERNEL_JOB_ID;
...
static void mirror_diag_event(int fd, uint32_t job_id, uint64_t seq, uint32_t status, uint32_t aux) {
    ...
    diag_slot = HETGPU_SIFIVE_DIAG_RING_SLOT +
                (g_sifive_id < HETGPU_SIFIVE_COUNT ? (uint32_t)g_sifive_id : 0U);
    if (!g_ddr_info.ddr_base ||
        g_ddr_info.ddr_size < (uint64_t)(diag_slot + 1) * HETGPU_SIFIVE_CONTROL_BYTES) {
        return;
    }

    index = g_diag_ring_index++;
    event.magic = HETGPU_SIFIVE_DIAG_MAGIC;
    event.index = index;
    event.status = status;
    event.job_id = job_id;
    event.aux = aux;
    ...
    phys = g_ddr_info.ddr_base +
           (uint64_t)diag_slot * HETGPU_SIFIVE_CONTROL_BYTES +
           HETGPU_SIFIVE_DIAG_RING_OFF +
           (uint64_t)(index % HETGPU_SIFIVE_DIAG_RING_RECORDS) * sizeof(event);
...
static void mirror_rmsnorm_debug_record(int fd, const struct RmsNormDebugRecord *record) {
    ...
    rel = (uint64_t)HETGPU_SIFIVE_RMS_DEBUG_SLOT * HETGPU_SIFIVE_CONTROL_BYTES +
          (uint64_t)g_sifive_id * HETGPU_SIFIVE_RMS_DEBUG_RECORD_BYTES;
...
static bool aligned_completion_record_enabled(void) {
    const char *value = getenv("HETGPU_SIFIVE_JOBD_ALIGNED_COMPLETION_RECORD");
    if (value && *value) {
        return env_flag_true(value);
    }
    return false;
...
static void mirror_aligned_completion_record(int fd,
    ...
    mirror_off = parse_env_u64_default("HETGPU_SIFIVE_JOBD_COMPLETION_MIRROR_OFF",
                                       HETGPU_SIFIVE_COMPLETION_MIRROR_DEFAULT_OFF);
    if (mirror_off == 0) {
        return;
    }
    control_off = (uint64_t)g_sifive_id * HETGPU_SIFIVE_CONTROL_BYTES +
                  HETGPU_SIFIVE_COMPLETION_OFF;
    ...
    record.magic = HETGPU_SIFIVE_RMS_DEBUG_MAGIC;
    record.version = HETGPU_SIFIVE_JOB_VERSION;
    record.sifive_id = (uint32_t)g_sifive_id;
...
static void mirror_diag_progress_status(int fd, uint32_t job_id, uint64_t seq, uint32_t status) {
    const uint32_t slot = g_sifive_id < HETGPU_SIFIVE_COUNT ? (uint32_t)g_sifive_id : 0U;
    ...
    if (!g_ddr_info.ddr_base ||
        g_ddr_info.ddr_size < (uint64_t)(slot + 1) * HETGPU_SIFIVE_CONTROL_BYTES) {
        return;
    }
    phys = g_ddr_info.ddr_base +
           (uint64_t)slot * HETGPU_SIFIVE_CONTROL_BYTES +
...
static void early_devmem_diag_marker(const char *devmem, uint32_t status, uint64_t seq) {
    ...
    if (!env_flag_true(getenv("HETGPU_SIFIVE_JOBD_EARLY_DEVMEM_MARKER"))) {
        return;
    }

    ddr_base = parse_env_u64_default("HETGPU_SIFIVE_SHARED_DDR_SIFIVE_BASE", 0x80000000ULL);
    if (!ddr_base) {
        return;
    }
    if (g_page_size <= 0) {
    ...
    for (uint32_t slot = 0; slot < HETGPU_SIFIVE_COUNT; slot++) {
        uint64_t phys = ddr_base + (uint64_t)slot * HETGPU_SIFIVE_CONTROL_BYTES +
                        HETGPU_SIFIVE_COMPLETION_OFF;
...
int main(int argc, char **argv) {
    ...
    const char *config = "/etc/hetgpu_sifive_jobs.conf";
    bool strict = false;
    ...
    for (int i = 1; i < argc; i++) {
        if (!strcmp(argv[i], "--strict-job-id-only")) {
            ...
            config = argv[i] + 9;
        } else if ((!strcmp(argv[i], "--mbox") || !strcmp(argv[i], "--sifive-dev")) && i + 1 < argc) {
            mbox_path = argv[++i];
        } else if (!strncmp(argv[i], "--mbox=", 7)) {
            mbox_path = argv[i] + 7;
        } else if (!strncmp(argv[i], "--sifive-dev=", 11)) {
            mbox_path = argv[i] + 11;
        }
    }
    ...
    read_sifive_id_from_mbox(mbox_fd);
    g_shared_ddr_sifive_base =
        parse_env_u64_default("HETGPU_SIFIVE_SHARED_DDR_SIFIVE_BASE", 0x80000000ULL);
    if (g_shared_ddr_sifive_base && g_ddr_info.ddr_base &&
        g_shared_ddr_sifive_base != g_ddr_info.ddr_base) {
        log_msg("shared DDR host base=0x%" PRIx64 " sifive mmap base=0x%" PRIx64
                " size=0x%" PRIx64,
                g_ddr_info.ddr_base, g_shared_ddr_sifive_base,
                g_ddr_info.ddr_size);
    }
    early_devmem_diag_marker(devmem, 0x6d120000u, 3);
    g_shared_ddr_fd_user_off =
        parse_env_u64_default("HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF",
                              parse_env_u64_default("HETGPU_SIFIVE_SHARED_DDR_USER_OFF",
                                                    HETGPU_SIFIVE_SHARED_DDR_FD_USER_OFF));
    const char *shared_ddr_dev = getenv("HETGPU_SIFIVE_JOBD_SHARED_DDR_DEV");
    ...
    if (jobd_boot_marker_enabled()) {
        if (jobd_mbox_status_mmap_enabled() &&
            !mirror_host_status_mbox_mmap(boot_status_fd, SIFIVE_KERNEL_JOB_ID, 0, 0x6a11)) {
            mirror_host_status_mbox_mmap(mbox_fd, SIFIVE_KERNEL_JOB_ID, 0, 0x6a11);
        }
    }
    int map_fd = mbox_fd;
    ...
    if (jobd_claim_sifive_id_enabled()) {
        if (claim_sifive_id_from_shared_ddr(map_fd)) {
            early_devmem_diag_marker(devmem, 0x6d140000u | ((uint32_t)g_sifive_id << 8), 5);
        } else {
            early_devmem_diag_marker(devmem, 0x6d14e000u | ((uint32_t)g_sifive_id << 8), 5);
        }
    } else {
        early_devmem_diag_marker(devmem, 0x6d14f000u | ((uint32_t)g_sifive_id << 8), 5);
    }
    ...
    early_devmem_diag_marker(devmem, 0x6d150000u | ((uint32_t)g_sifive_id << 8), 6);
    ctl = scan_for_control(map_fd, &g_ddr_info, &control_map);
    if (!ctl) {
        early_devmem_diag_marker(devmem, 0x6d15e000u | ((uint32_t)g_sifive_id << 8), 6);
        if (close_map_fd) close(map_fd);
        close(mbox_fd);
        return 1;
    }
    early_devmem_diag_marker(devmem, 0x6d160000u | ((uint32_t)g_sifive_id << 8), 7);
    ...
    if (jobd_boot_marker_enabled()) {
        ...
        mirror_host_status(map_fd, SIFIVE_KERNEL_JOB_ID, 0, 0x6a21);
    }
    if (jobd_seed_current_jobs_enabled()) {
    ...
    if (!initial_dispatched) {
        ...
        mirror_host_status(map_fd, SIFIVE_KERNEL_JOB_ID, initial_seq, status);
        if (jobd_loop_trace_enabled()) {
            mirror_host_status_control_window_direct(SIFIVE_KERNEL_JOB_ID, initial_seq, 0x6bd00000u);
        }
        write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, initial_seq, 0x6ac0, initial_detail);
    }
    for (;;) {
        ...
        if (poll_result == DISPATCH_HANDLED) {
            write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq,
        ...
        if (jobd_loop_trace_enabled()) {
            mirror_host_status_control_window_direct(SIFIVE_KERNEL_JOB_ID, heartbeat_tick + 1, 0x7b100000u);
        }
        if (jobd_boot_marker_enabled()) {
            mirror_host_status(map_fd,
                               SIFIVE_KERNEL_JOB_ID,
                               heartbeat_tick + 1,
                               0x7a100000u);
        }
        if (jobd_loop_trace_enabled()) {
            mirror_host_status_control_window_direct(SIFIVE_KERNEL_JOB_ID, heartbeat_tick + 1, 0x7b110000u);
        }
        pending_job = control_has_pending_job(map_fd, last_seq, last_kernel_seq);
        if (jobd_loop_trace_enabled()) {
            mirror_host_status_control_window_direct(SIFIVE_KERNEL_JOB_ID, heartbeat_tick + 1,
        ...
        mirror_progress_status(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7001);
        write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7001, 0);
        mirror_progress_status(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq,
        ...
        if (!pending_job && jobd_notify_irq_enabled() && g_response_irq_pending) {
            ...
            if (ret < 0) {
                ...
                pending_job = control_has_pending_job(map_fd, last_seq, last_kernel_seq);
                if (pending_job) {
                    mirror_progress_status(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7006);
                    write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7006, 0);
                }
             ...
             * response and the SIFIVE-side poll can sleep past the new job.
             */
            pending_job = control_has_pending_job(map_fd, last_seq, last_kernel_seq);
            if (pending_job) {
                mirror_progress_status(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7006);
...
after_response_irq:
        if (!pending_job && pre_poll_scan_us() != 0) {
            ...
            if (pending_job) {
                mirror_progress_status(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7008);
                write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7008,
                                  (uint32_t)(scans & 0xffffffffu));
            }
        }
        if (jobd_mbox_poll_enabled() && !pending_job) {
            woke_from_poll = wait_for_control(mbox_fd);
            mirror_progress_status(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7003);
            write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7003, 0);
        }
        ...
        if ((snapshot_detail & 0x3u) == 0) {
            struct SifiveJobDesc mbox_desc;
            if (read_mbox_kernel_desc(mbox_fd, &mbox_desc) &&
                ...
                snapshot_detail = control_snapshot_detail(g_control_snapshot,
                                                          ...
                                                          last_kernel_seq,
                                                          NULL);
                write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID,
        ...
        if ((snapshot_detail & 0x1f2u) == 0x1f0u) {
            const struct SifiveJobDesc *snap_desc =
                (const struct SifiveJobDesc *)(const void *)g_control_snapshot;
        ...
        write_jobd_beacon(map_fd, SIFIVE_KERNEL_JOB_ID, last_kernel_seq, 0x7004, snapshot_detail);
