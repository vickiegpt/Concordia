// emit_pacc_vcix.rs - PACC VCIX intrinsic emission for RISC-V IME matrix operations
//
...
/// Matrix element types supported by PACC/IME
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum PaccElementType {
    Int4,
    Int8,
    Uint8,
    Int16,
...
impl PaccElementType {
    ...
    pub fn llvm_scalar_type(&self) -> &'static str {
        match self {
            PaccElementType::Int4 => "i4",
            PaccElementType::Int8 | PaccElementType::Uint8 => "i8",
            PaccElementType::Int16 | PaccElementType::Uint16 => "i16",
            PaccElementType::Int32 => "i32",
            PaccElementType::Float16 => "half",
            PaccElementType::Bfloat16 => "bfloat",
            PaccElementType::Float32 => "float",
        }
    }
}

/// Hardware configuration for PACC tile dimensions
#[derive(Debug, Clone)]
pub struct PaccTileConfig {
    /// VLEN in bits
    pub vlen: usize,
...
impl Default for PaccTileConfig {
    fn default() -> Self {
        Self::new(256, 8)
    }
}
...
pub struct VcixIntrinsicCall {
    ...
    /// Source element type
    pub src_type: PaccElementType,
    /// Accumulator/destination element type
    pub dst_type: PaccElementType,
    /// Tile configuration
    pub tile: PaccTileConfig,
}
...
pub fn plan_mma_vcix(
    a_type: PaccElementType,
    b_type: PaccElementType,
    c_type: PaccElementType,
    d_type: PaccElementType,
    vlen: usize,
) -> VcixIntrinsicCall {
    ...
    let tile = PaccTileConfig::new(vlen, src_sew);
...
/// Generate LLVM IR text for the intrinsic declarations needed by PACC.
///
...
impl ZvbdotInstr {
    ...
    /// Source element type
    pub fn src_element_type(&self) -> PaccElementType {
        match self {
            ZvbdotInstr::Vqbdotu => PaccElementType::Uint8,
            ZvbdotInstr::Vqbdots => PaccElementType::Int8,
            ZvbdotInstr::Vfqbdot | ZvbdotInstr::VfqbdotAlt => PaccElementType::Int8, // OFP8
            ZvbdotInstr::Vfwbdot | ZvbdotInstr::Vfwldot => PaccElementType::Bfloat16,
            ZvbdotInstr::Vfbdot => PaccElementType::Float32,
            ZvbdotInstr::Vqldotu => PaccElementType::Uint8,
            ZvbdotInstr::Vqldots => PaccElementType::Int8,
        }
    }
...
pub fn select_zvbdot_instr(
    ...
    match (a_type, d_type) {
        ...
        (PaccElementType::Int8, PaccElementType::Int32) => Some(ZvbdotInstr::Vqbdots),
        (PaccElementType::Uint8, PaccElementType::Int32) => Some(ZvbdotInstr::Vqbdotu),

        // bf16 × bf16 → fp32: widening block dot product
        (PaccElementType::Bfloat16, PaccElementType::Float32) => Some(ZvbdotInstr::Vfwbdot),

        // fp32 × fp32 → fp32: block dot product
        (PaccElementType::Float32, PaccElementType::Float32) => Some(ZvbdotInstr::Vfbdot),

        // fp16 → fp32: no direct Zvbdot, would need conversion + vfwbdot
        (PaccElementType::Float16, PaccElementType::Float32) => None,
...
pub fn plan_mma_zvbdot(
    ...
    let tile = PaccTileConfig::new(vlen, a_type.sew_bits());
...
/// Generate a PACC kernel module using Zvbdot instructions (for spike simulation).
pub fn emit_pacc_zvbdot_kernel_module(
    kernel_name: &str,
    vlen: usize,
    a_type: PaccElementType,
    d_type: PaccElementType,
...
/// Convert PTX ScalarType to PaccElementType
pub fn ptx_scalar_to_pacc(scalar_type: u32) -> PaccElementType {
    // Map based on PTX scalar type enum values
    // These match the ptx_parser::ast::ScalarType variants
    match scalar_type {
        // U8
        0 => PaccElementType::Uint8,
        // S8
        1 => PaccElementType::Int8,
        // U16
        4 => PaccElementType::Uint16,
        // S16
        5 => PaccElementType::Int16,
        // U32
        8 => PaccElementType::Uint8, // fallback
        // S32
        9 => PaccElementType::Int32,
        // F16
        12 => PaccElementType::Float16,
        // F32
        14 => PaccElementType::Float32,
        // BF16
        18 => PaccElementType::Bfloat16,
        _ => PaccElementType::Int8, // default fallback
    }
}
...
mod tests {
    ...
    fn test_tile_config_vlen256() {
        let tile = PaccTileConfig::new(256, 8);
        assert_eq!(tile.m, 2);
        assert_eq!(tile.n, 2);
        assert_eq!(tile.k, 16);
        assert!(!tile.copies2);
    ...
    fn test_tile_config_vlen128() {
        let tile = PaccTileConfig::new(128, 8);
        assert_eq!(tile.m, 1);
        assert_eq!(tile.k, 16);
    ...
    fn test_emit_kernel_module() {
        let module = emit_pacc_kernel_module("test_matmul", 256);
    ...
    fn test_emit_zvbdot_kernel_module() {
        let module = emit_pacc_zvbdot_kernel_module(
            "test_bdot",
            512,
            PaccElementType::Int8,
            PaccElementType::Int32,
    ...
    fn test_tile_config_vlen512() {
        let tile = PaccTileConfig::new(512, 8);
