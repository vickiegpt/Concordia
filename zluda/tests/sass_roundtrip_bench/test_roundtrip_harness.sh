...
rg -q 'HETGPU_SASS_LIFTER_CUBIN_DUMP_DIR' "${REPO_ROOT}/zluda/src/impl/module.rs"
...
rg -q 'HETGPU_SASS_LIFTER_CUOBJDUMP="\$\{CUOBJDUMP\}"' "${SCRIPT_DIR}/run_kimi_k26_e2e.sh"
...
rg -q 'HETGPU_SASS_LIFTER_CUOBJDUMP="\$\{CUOBJDUMP\}"' "${SCRIPT_DIR}/run_kimi_k26_numerical_proof.sh"
